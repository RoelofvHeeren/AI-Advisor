...
### Initialize with a Private Integration Token[​](#initialize-with-a-private-integration-token "Direct link to Initialize with a Private Integration Token")
...
### Initialize with OAuth credentials[​](#initialize-with-oauth-credentials "Direct link to Initialize with OAuth credentials")
...
### Make your first API call[​](#make-your-first-api-call "Direct link to Make your first API call")
...
## Webhook support[​](#webhook-support "Direct link to Webhook support")
