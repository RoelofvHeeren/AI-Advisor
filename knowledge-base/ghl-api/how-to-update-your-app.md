...
## 1\. What Is App Versioning?[​](#1-what-is-app-versioning "Direct link to 1. What Is App Versioning?")
...
## 2\. Purpose[​](#2-purpose "Direct link to 2. Purpose")
...
## 3\. Versioning System – How It Works[​](#3-versioning-system--how-it-works "Direct link to 3. Versioning System – How It Works")
...
### Available Version States[​](#available-version-states "Direct link to Available Version States")
...
### Version Limits[​](#version-limits "Direct link to Version Limits")
...
-   _(In Review + Deprecated + Live) ≤ 2_
...
## 4\. Creating a New Version (Draft)[​](#4-creating-a-new-version-draft "Direct link to 4. Creating a New Version (Draft)")
...
## 5\. Publishing an Update[​](#5-publishing-an-update "Direct link to 5. Publishing an Update")

When your draft is ready, publish it by following these steps.

### Step 1 — Choose a Version Type[​](#step-1--choose-a-version-type "Direct link to Step 1 — Choose a Version Type")
...
### Step 2 — Add Release Notes[​](#step-2--add-release-notes "Direct link to Step 2 — Add Release Notes")
...
### Step 3 — Review or Go Live[​](#step-3--review-or-go-live "Direct link to Step 3 — Review or Go Live")
...
## 6\. Major vs Minor vs Patch — What Users Experience[​](#6-major-vs-minor-vs-patch--what-users-experience "Direct link to 6. Major vs Minor vs Patch — What Users Experience")
...
## 7\. What Users See When an Update Is Live[​](#7-what-users-see-when-an-update-is-live "Direct link to 7. What Users See When an Update Is Live")
...
## 8\. Deprecating Old Versions[​](#8-deprecating-old-versions "Direct link to 8. Deprecating Old Versions")
...
## 9\. Future Milestones[​](#9-future-milestones "Direct link to 9. Future Milestones")
