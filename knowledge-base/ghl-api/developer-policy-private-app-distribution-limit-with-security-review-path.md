...
url: "https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits"
category: ""
---
...
## Effective date[​](#effective-date "Direct link to Effective date")
...
## Key definitions[​](#key-definitions "Direct link to Key definitions")
...
## Thresholds and behavior[​](#thresholds-and-behavior "Direct link to Thresholds and behavior")
...
### Install experience[​](#install-experience "Direct link to Install experience")
...
### Real‑time enforcement[​](#realtime-enforcement "Direct link to Real‑time enforcement")

Counts update in real time as installs/uninstalls occur.

* * *

## Security Review[​](#security-review "Direct link to Security Review")

### When you can request[​](#when-you-can-request "Direct link to When you can request")

Only **after you exceed the cap** (installs in **6 or more Agencies**).

### What you submit[​](#what-you-submit "Direct link to What you submit")
...
### Outcomes[​](#outcomes "Direct link to Outcomes")
...
### Re‑review[​](#rereview "Direct link to Re‑review")
...
## Publishing publicly[​](#publishing-publicly "Direct link to Publishing publicly")

You can remove the Private cap by publishing as **Public (listed)**.

### How to publish[​](#how-to-publish "Direct link to How to publish")
...
### Public listing requirements[​](#public-listing-requirements "Direct link to Public listing requirements")
...
## Where you’ll see this in product[​](#where-youll-see-this-in-product "Direct link to Where you’ll see this in product")
...
## Converting between Public and Private[​](#converting-between-public-and-private "Direct link to Converting between Public and Private")
...
## Legacy scope[​](#legacy-scope "Direct link to Legacy scope")
...
## Optional: Bulk Installation (Public apps)[​](#optional-bulk-installation-public-apps "Direct link to Optional: Bulk Installation (Public apps)")
...
**Need help?** Email us on **[\[email protected\]](/cdn-cgi/l/email-protection#80ede1f2ebe5f4f0ece1e3e5c0e7efe8e9e7e8ece5f6e5ecaee3efed)**

* * *

## Versioning & change log[​](#versioning--change-log "Direct link to Versioning & change log")
...
## Change management[​](#change-management "Direct link to Change management")
