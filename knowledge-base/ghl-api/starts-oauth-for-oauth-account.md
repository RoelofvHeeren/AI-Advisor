---
title: "Starts OAuth For Oauth Account"
...
### The accountId retrieved from above data can be used to fetch account details using below API -[​](#the-accountid-retrieved-from-above-data-can-be-used-to-fetch-account-details-using-below-api-- "Direct link to The accountId retrieved from above data can be used to fetch account details using below API -")
