---
title: "Agency | Managing User Roles & Permissions"
...
-   [Assign Permissions](#Assign-Permissions)[](#Sub-Account-Settings-\(Granular-Permissions\))[](#Sub-Account-Settings-\(Granular-Permissions\))
-   [Sub-Account Settings (Granular Permissions)](#Sub-Account-Settings-\(Granular-Permissions\))
-   [Steps to Stop a User From Opening New Sub-accounts](#Steps-to-Stop-a-User-From-Opening-New-Sub-accounts)
-   [Copy Permissions](#Copy-Permissions)
-   [Adding Clients to a Sub-Account with Limited Access](#Adding-Clients-to-a-Sub-Account-with-Limited-Access)
