...
url: "https://help.gohighlevel.com/support/solutions/articles/155000001982-understanding-pipelines"
...
-   [Overview](#Overview)
-   [Pipelines List View](#Pipelines-List-View)
-   [Why Pipelines Matter](#Why-Pipelines-Matter)
-   [Pipeline Stages](#Pipeline-Stages)
-   [Editing a Pipeline and Its Stages](#Editing-a-Pipeline-and-Its-Stages)
-   [Deleting a Pipeline Stage](#Deleting-a-Pipeline-Stage)
-   [How it works](#How-it-works%E2%80%8B)
-   [Example Pipeline Stages](#Example-Pipeline-Stages)
-   [Example: Sales Pipeline](#Example%3A-Sales-Pipeline%E2%80%8B)
-   [Example: Service Business Pipeline](#Example%3A-Service-Business-Pipeline)
-   [Best Practices](#Best-Practices)
-   [Keep It Simple](#Keep-It-Simple)
-   [Automate Smartly](#Automate-Smartly)
-   [Review Regularly](#Review-Regularly)[](#Data-Driven-Optimization)
-   [Data-Driven Optimization](#Data-Driven-Optimization)[Common Use Cases](#Common-Use-Cases)
-   [FAQs](#FAQs)
-   [Q: Do I lose opportunities when I delete a pipeline stage?](#Q%3A-Do-I-lose-opportunities-when-I-delete-a-pipeline-stage?)
-   [Q: Is the updated Pipelines experience required?](#Q%3A-Is-the-updated-Pipelines-experience-required?)
-   [Q: Did any pipeline functionality change?](#Q%3A-Did-any-pipeline-functionality-change?)
-   [Q: Do existing automations still work?](#Q%3A-Do-existing-automations-still-work?)
-   [Useful Links](#Useful-Links%E2%80%8B)
...
_![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064130331/original/cysN3cSv0IWbeH5dCWGnN-3t6S-7LDh5Nw.png?1770163033)_
...
_![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064130340/original/qsA3sdj2jWZWMKEas_RxFvQrm4yaDWzO7g.png?1770163078)_  
...
> Example: Move an opportunity to _Appointment Scheduled_ only after a meeting is confirmed on the calendar.
...
-   [Creating a Pipeline](https://help.gohighlevel.com/en/support/solutions/articles/155000001985)
