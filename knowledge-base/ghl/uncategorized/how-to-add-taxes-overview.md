---
title: "How-to add Taxes Overview"
url: "https://help.gohighlevel.com/support/solutions/articles/48001224104-how-to-add-taxes-overview"
...
HighLevel calculates and displays tax rates up to 4 decimal places (for example, 7.1250%) to improve accuracy for fractional tax rates.

  

Tax amounts still round to 2 decimal places based on currency standards (for example, $1.78).

  

Where you will see 4-decimal tax rates:

Tax rates display with 4 decimals across invoices, estimates, subscriptions, transaction details, receipts, and checkout experiences. Tax rates also export with 4 decimals in CSV exports and appear with 4 decimals in supported API responses.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064184287/original/ZprueHgdXJqSAcnk7WT0HY6QIWyLFXnR4w.png?1770212650)
