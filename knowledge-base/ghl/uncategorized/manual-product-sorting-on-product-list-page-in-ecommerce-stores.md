---
title: "Manual Product Sorting on Product List Page in Ecommerce Stores"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005531-manual-product-sorting-on-product-list-page-in-ecommerce-stores"
category: "Uncategorized"
---

# Manual Product Sorting on Product List Page in Ecommerce Stores
...
In the same Product List element settings, you can also increase **products per page** under **Layout** (up to **100**) to reduce excessive pagination for large catalogs. 
...
Mobile shoppers can override manual ordering using the **Sort** bottom sheet (e.g., Price: Low → High).  

  

For curated sequences, keep the **Default Sorting option** set to **Featured** so the PLP loads your intended order before users choose a different sort.
