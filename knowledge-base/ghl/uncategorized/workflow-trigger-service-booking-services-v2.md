---
title: "Workflow Trigger – Service Booking (Services v2)"
...
-   [What is the Service Booking Trigger?](#What-is-the-Service-Booking-Trigger?)
-   [Key Benefits of the Service Booking Trigger](#Key-Benefits-of-the-Service-Booking-Trigger)
-   [When It’s Triggered](#When-It%E2%80%99s-Triggered)
-   [Key Differences from Appointment Status Trigger](#Key-Differences-from-Appointment-Status-Trigger)
-   [Available Filters](#Available-Filters)
-   [Trigger Visibility](#Trigger-Visibility)
-   [Order Submission Trigger Behavior with Service Bookings](#Order-Submission-Trigger-Behavior-with-Service-Bookings)
-   [Supported Appointment Actions](#Supported-Appointment-Actions)
-   [Using Custom Values with Service Bookings](#Using-Custom-Values-with-Service-Bookings)
-   [How to Customize It](#How-to-Customize-It)
-   [How to Set Up the Service Booking Workflow Trigger](#How-to-Set-Up-the-Service-Booking-Workflow-Trigger)
...
Looking for more information on custom values? Check out [How to use Custom Values](https://help.gohighlevel.com/en/support/solutions/articles/48001161575)
...
-   Configure the trigger to your needs using the necessary filters. [Click here for more information on the available filters.](#Available-Filters)  
...
-   [](https://help.gohighlevel.com/en/support/solutions/articles/155000006240)[Services - Overview & How to Get Started](https://help.gohighlevel.com/en/support/solutions/articles/155000006240)[](https://help.gohighlevel.com/en/support/solutions/articles/155000006240)  
...
-   [How to use Custom Values](https://help.gohighlevel.com/en/support/solutions/articles/48001161575)[](https://help.gohighlevel.com/en/support/solutions/articles/155000006140)