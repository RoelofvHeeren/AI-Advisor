---
title: "Eliza Agent Platform - Introduction and FAQs"
...
-   #### [6\. When an appointment is created for a contact, the contact is not removed from the chat queue. Do I need to do anything special to make them be removed (as far as tags go or anything?)](#6.-When-an-appointment-is-created-for-a-contact,-the-contact-is-not-removed-from-the-chat-queue.-Do-I-need-to-do-anything-special-to-make-them-be-removed-\(as-far-as-tags-go-or-anything?\))
