---
title: "Adding Custom Forms to Calendars"
...
**Q: Will my custom-form data be saved if the appointment isn't booked?**

Custom-form responses are stored in the contact record only after the visitor clicks the final ‘Book Appointment’ button. If the visitor abandons the process before that step, no data is written to the CRM.
