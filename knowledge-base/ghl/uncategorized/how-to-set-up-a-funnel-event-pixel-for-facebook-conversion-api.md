---
title: "How to set up a Funnel Event Pixel for Facebook Conversion API?"
...
-   [How to set up Meta CAPI (Conversions API) Funnel Event?](#How-to-set-up-Meta-CAPI-\(Conversions-API\)-Funnel-Event?)
    -   [Step 1: Create an Meta Pixel/Dataset:](#Step-1%3A-Create-an-Meta-Pixel/Dataset%3A)
-   [Step 2: Apply Pixel Code to your Funnel/Website.](#Step-2%3A-Apply-Pixel-Code-to-your-Funnel/Website.)
    -   [Step 3: Create a Meta Conversions API Workflow.](#Step-3%3A-Create-a-Meta-Conversions-API-Workflow.)
-   [Custom Values:](#Custom-Values%3A)
