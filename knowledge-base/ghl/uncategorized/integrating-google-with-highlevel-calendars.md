---
title: "Integrating Google with HighLevel Calendars"
...
1.  Go to your sub-account and select use the left side navigation bar to select **Calendars** then click **Calendar Settings** in the upper right corner  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155050180404/original/7DzuYUvJc0EGi-lSow3gnOwZyyqaovKwtg.png?1753112360)  
      
    
2.  Click on the **Connections** tab in the upper navigation ribbon and then **\+ Add New** button to add a new calendar.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155050180701/original/dbjrV8gci36b1H-taFZVzuTRn4AEZ5PyMw.png?1753112644)
...
1.  From the **Connections** page, click on the **Connect** button beside Google Calendar.  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155050180794/original/_sWTEdQBEEhDnXoyRt-Ef4d2efTeCUjC1g.png?1753112712)  
...
3.  Accept **all requested permissions**, including: **Calendar** (read/write), **Profile** and **Email** access.  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155050180917/original/TsIcIfPiiMCzymf4Tg4IVsCb94ML43i2YQ.png?1753112811)  
...
[](https://help.gohighlevel.com/en/support/solutions/articles/48001181302)Also check Settings → Integrations → Google for a missing-permissions warning and click Reconnect if required permissions are missing.
