---
title: "Email Sending Guide:  Email Best Practices & Email Warm Up"
...
If your dedicated sending domain is a subdomain (e.g., mail.gohighlevel.com), you can use either name@gohighlevel.com or name@mail.gohighlevel.com. Deliverability is the same when SPF, DKIM, and DMARC are set up correctly.

  

Do not use a From Email on a different organizational domain (e.g., name@otherbrand.com) if your sending domain is \*.gohighlevel.com.
...
**Sending domain:** mail.gohighlevel.com → Valid From: highly-test@gohighlevel.com or someone@mail.gohighlevel.com

  

**Invalid:** Sending domain mail.gohighlevel.com with From user@otherbrand.com
...
If you IP is blacklisted, reach out to support. [Click here for details on how to reach support.](https://help.gohighlevel.com/en/support/solutions/articles/155000000969)
