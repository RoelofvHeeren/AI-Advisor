---
title: "Voice AI: Multi-Language Support"
url: "https://help.gohighlevel.com/support/solutions/articles/155000004683-voice-ai-multi-language-support"
...
-   [What is Multi-Language Support for Voice AI?](#What-is-Multi-Language-Support-for-Voice-AI?)
    -   [Key Benefits of Multi-Language Voice AI](#Key-Benefits-of-Multi-Language-Voice-AI)
    -   [Supported Languages](#Supported-Languages)
    -   [How to Configure Multi-Language Support](#How-to-Configure-Multi-Language-Support)
    -   [Best Practices for Optimal Performance](#Best-Practices-for-Optimal-Performance)
...
## **How to Configure Language for Voice AI**
...
1.  From the left navigation bar, choose AI Agents.  
      
    
2.  Select the Voice AI tab on the top ribbon.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060261162/original/OhgWUEeErhOg7eP9HynBo2lG3uniapF9iQ.png?1765314971)
...
1.  Select Agent List from the secondary top navigation ribbon.  
      
    
2.  Locate the agent your would like to update and click the agent’s name to open up the Agent Details.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060261206/original/j45WcOhCoDCRsrpP74eQKWzakSbpPUQSTQ.png?1765315077)
...
1.  Use the dropdown menu to choose one of the supported languages  
      
    
2.  Your greeting will automatically update to align with the selected language for a seamless user experience. You can proof-read and edit this message in the **Agent's Initial Message box**  
...
Once everything is configured, save your settings. Test your Voice Agent before deploying. For more information on testing your Voice Agent, [click here](https://help.gohighlevel.com/en/support/solutions/articles/155000004108)
