---
title: "Integrating Outlook with HighLevel Calendars"
...
**Q: What if my Outlook calendar was deleted and HighLevel shows an error banner?**Click **Fix This** on the banner to review deleted calendar instances and where they’re connected in HighLevel. Then select **Remove Deleted Calendars** to remove broken connections and restore an error-free setup. 
