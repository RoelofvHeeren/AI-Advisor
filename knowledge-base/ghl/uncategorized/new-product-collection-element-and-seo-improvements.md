---
title: "New product collection element and SEO Improvements"
...
**Select and map collections directly on the canvas**

To speed up setup, you can now select items inside the Collections List element directly from the canvas.

**Double-click an item in the Collections List element:**

If the item is not mapped to a real collection, the selection drawer opens automatically so you can assign a collection. (Needs Confirmation: drawer label/location.)

If the item is already mapped, the selected collection is highlighted on the canvas for clarity.

**Two-way sync:** Changes you make in the selection drawer update the canvas immediately, and canvas selections reflect in the drawer.

**Stable ordering:** The selection order stays consistent even when you add or remove items from the element.
