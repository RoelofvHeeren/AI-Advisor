---
title: "Listings - Self Service Onboarding"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006127-listings-self-service-onboarding"
category: "Uncategorized"
---

# Listings - Self Service Onboarding
...
-   [What is Listings Self Service Onboarding?](#What-is-Listings-Self-Service-Onboarding?)
-   [Key Benefits of Listings Self Service Onboarding](#Key-Benefits-of-Listings-Self-Service-Onboarding)
-   [How To Setup Listings Self Service Onboarding](#How-To-Setup-Listings-Self-Service-Onboarding)
    -   [Submit Entity Form](#Submit-Entity-Form)
    -   [Add Business Hours](#Add-Business-Hours)
    -   [Connect Google & Facebook](#Connect-Google-&-Facebook)
    -   [Add Services & Keywords](#Add-Services-&-Keywords)
    -   [Add Social Media URLs](#Add-Social-Media-URLs)
-   [Roles, Permissions & Prerequisites](#Roles,-Permissions-&-Prerequisites)
...
_C_ompleting onboarding in the intended flow reduces errors and speeds up activation. Follow the steps below to locate the widget, complete each step, and verify full completion across all entities.  
...
2.  Go to **Reputation → Listings**  
      
    
3.  Locate the **Self Service Onboarding** widget at the top of the Listings dashboard  
      
    When visiting for the first time:  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053144329/original/9caOfe7V7w21SPCQg26DN9EkKfYVRJXK1A.png?1757030126)
    
      
      
    When re-visiting:  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053144365/original/2vpw3XotSzHkbsm_v4u92ZvQOs5i8bTDIQ.png?1757030392)  
      
    
4.  Click the **Start Setup** button in the widget to Initiate **Entity Form**, then proceed with  
    ...
    Steps can be completed in any order; use **Skip** if you need to come back later.  
      
    
5.  For multi‑entity accounts, repeat remaining steps for each incomplete entity. The widget persists until **all required steps are complete for every incomplete entity**.  
      
    
6.  When onboarding is fully complete across all entities, the widget disappears automatically.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052931736/original/cxpotx4AqHzfE0FLxmtKKn0s_Qo9Fy56gA.png?1756824476)
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052562333/original/g5-qBIS0TxzR-G-Jg65vHLHfFEhVXLbWBg.png?1756372399)
...
1.  Open the onboarding widget and choose **Add Business Hours**.
    
2.  Enter regular hours (and optionally add special/holiday hours if available in your account).
    
3.  Save your changes; you’ll see the status update in the widget.  
      
    

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052562684/original/FBTol-HesFdVPirE3a_kXZUe67sjKGFAAA.png?1756372557)
...
1.  From the widget, select **Connect Google** and complete the OAuth prompts with the correct Google account.
    
2.  Select **Connect Facebook** and approve requested permissions for the intended Page.
    
3.  Return to Listings and verify you see **Connected** status/badges for each publisher.
    

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052562726/original/6FeyknywbChmhQ3G1znK2qN6J9ACASrJhw.png?1756372576)
...
1.  Open the widget and select **Add Business Services & Keywords**.
    
2.  Enter your primary services and relevant keywords that describe your business.
    
3.  Save to reflect progress in the widget.  
      
    

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052562778/original/_f2jIn9RAC5jYNztRJjEhc_tohhhLuwwuA.png?1756372594)
...
1.  Choose **Add Social Media URLs** in the widget.
    
2.  Paste the full URLs for your business’s official profiles.
    
3.  Save. The widget updates to show completion.
    

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052562832/original/IVs_vMAEEM-AwIwLlrkJkAY9G9cahLVT5w.png?1756372611)
...
-   [Adding Additional Attributes to Listings](https://help.gohighlevel.com/support/solutions/articles/155000003529-adding-additional-attributes-to-listings)  
