---
title: "Agency Dashboard - SaaS Analytics & MRR"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006991-agency-dashboard-saas-analytics-mrr"
...
-   [What is the SaaS Analytics in the Agency Dashboard?](#What-is-the-SaaS-Analytics-in-the-Agency-Dashboard?)[](#Key-Benefits-of-the-SaaS-Analytics-Tab)
-   [Key Benefits of the SaaS Analytics Tab](#Key-Benefits-of-the-SaaS-Analytics-Tab)[](#How-to-Access-and-Read-SaaS-Analytics)
-   [How to Access and Read SaaS Analytics](#How-to-Access-and-Read-SaaS-Analytics)[](#State-Transitions-%E2%86%92-MRR-Type)
-   [State Transitions → MRR Type](#State-Transitions-%E2%86%92-MRR-Type)[](#Subscription-Status-Meanings)
-   [Subscription Status Meanings](#Subscription-Status-Meanings)[](#What%E2%80%99s-Included-vs-Excluded-in-HighLevel-MRR)
-   [What’s Included vs Excluded in HighLevel MRR](#What%E2%80%99s-Included-vs-Excluded-in-HighLevel-MRR)[](#Methodology-&-Currency-Handling)
-   [Methodology & Currency Handling](#Methodology-&-Currency-Handling)[](#Frequently-Asked-Questions)
...
| From → To | Maps to | Notes |
| --- | --- | --- |
| Trialing → Active (paid) | **New MRR** | First paid month after trial. |
| None → Active (new paid) | **New MRR** | First-time purchase without trial. |
| Active → Active (higher plan) | **Expansion MRR** | Upgrade or increased recurring value. |
| Active → Active (lower plan) | **Contraction MRR** | Downgrade or reduced recurring value. |
| Active → Cancelled | **Churned MRR** | Cancellation at period end or immediate per policy. |
| Cancelled/Paused → Active | **Reactivation MRR** | Subscription returns to paid/active. |
...
<table style="font-family: Arial, Helvetica, sans-serif;"><tbody><tr><td dir="ltr"><span style="font-family: Arial,Helvetica,sans-serif;">Status</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Meaning</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Counted in MRR?</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Active</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Current paid subscription in good standing.</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Yes</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Past Due</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Payment failed; grace logic may apply.</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Yes, until cancellation per policy</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Trialing</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Free/discounted trial before first payment.</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">No (until paid)</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Paused</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Temporarily suspended at customer/agency action.</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">No, unless reactivated</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Cancelled</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Ended subscription; no active billing.</span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">No (contributes to churn when it occurs)</span></td></tr><tr><td><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Unpaid/Incomplete</strong></span></td><td><span style="font-family: Arial,Helvetica,sans-serif;">Payment setup incomplete or unpaid.</span></td><td dir="ltr"><span style="font-family: Arial,Helvetica,sans-serif;">No</span></td></tr></tbody></table>
...
-   [](https://help.gohighlevel.com/en/support/solutions/articles/48000982604)[How To Upgrade to HighLevel's Agency Pro Plan ($497 SaaS plan)](https://help.gohighlevel.com/en/support/solutions/articles/48001180534)  
      
    
-   [HighLevel vs Profitwell vs Stripe MRR](https://help.gohighlevel.com/en/support/solutions/articles/155000006997)  
