---
title: "How to Merge Duplicate Contacts in HighLevel"
...
If the duplicate contact is deleted during the merge, HighLevel transfers the workflow execution to the master contact so the automation continues. If the master is already enrolled in the same workflow, HighLevel stops the extra run and keeps the execution that’s already running.
