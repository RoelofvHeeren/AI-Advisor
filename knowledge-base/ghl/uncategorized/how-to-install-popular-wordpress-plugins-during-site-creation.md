---
title: "How to Install Popular WordPress Plugins During Site Creation"
...
Yes—on \*\*new WordPress sites provisioned via HighLevel Hosting\*\*, HighLevel automatically installs the \*\*LeadConnector (LC) plugin\*\* during setup. All other plugins in the \*\*Popular Plugins\*\* step remain optional and install only if you select them.
