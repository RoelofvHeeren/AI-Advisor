...
url: "https://help.gohighlevel.com/support/solutions/articles/48001239875-workflow-settings-overview"
...
-   [What are Workflow Settings?](#What-are-Workflow-Settings?)
-   [Key Benefits of Configuring Workflow Settings](#Key-Benefits-of-Configuring-Workflow-Settings)
-   [How to Access Workflow Settings](#How-to-Access-Workflow-Settings)
-   [Contact Settings](#Contact-Settings)
    -   [Allow Re-entry](#Allow-Re-entry)
    -   [Allow multiple Opportunities](#Allow-multiple-Opportunities)
    -   [Stop on Response](#Stop-on-Response)
    -   [How does Stop On Response work with the Call Action?](#How-does-Stop-On-Response-work-with-the-Call-Action?)
-   [Communication Settings](#Communication-Settings)
    -   [Timezone](#Timezone)
    -   [Time Window](#Time-Window)
    -   [Sender Details](#Sender-Details)
    -   [Conversations - Mark as Read](#Conversations---Mark-as-Read)
