---
title: "Porting your phone number (non-Twilio number) to a location/subaccount"
...
-   [What is porting?](#What-is-porting?%C2%A0) 
-   [Prerequisites](#Prerequisites)
-   [Decide Your Destination Carrier (Important)](#Decide-Your-Destination-Carrier-\(Important\))
-   [Submit Your Port Request](#Submit-Your-Port-Request)
    -   [Step 1: Gather documents](#Step-1%3A-Gather-documents)
    -   [Step 2: Complete the High-Level Porting Form (US numbers)](#Step-2%3A-Complete-the-High-Level-Porting-Form-\(US-numbers\))
    -   [Step 3: Approval & FOC (Firm Order Commitment)](#Step-3%3A-Approval-&-FOC-\(Firm-Order-Commitment\))
-   [After the Port — Compliance & Deliverability](#After-the-Port-%E2%80%94-Compliance-&-Deliverability)
