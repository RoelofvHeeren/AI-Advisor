...
-   [What are Test Calls for Voice AI Agents?](#What-are-Test-Calls-for-Voice-AI-Agents?)
-   [Key Benefits of Test Calls](#Key-Benefits-of-Test-Calls)
-   [How To Setup Test Calls (Web Call & Phone Call)](#How-To-Setup-Test-Calls-\(Web-Call-&-Phone-Call\))
    -   [Type 1 : Start a Web Call](#Type-1-%3A-Start-a-Web-Call)
    -   [Type 2: Start a Phone Call](#Type-2%3A-Start-a-Phone-Call)
-   [Test Calls while creating an agent](#Test-Calls-while-creating-an-agent)
-   [Test Call History & Logs](#Test-Call-History-&-Logs)
-   [Outbound Scenario availability](#Outbound-Scenario-availability)
...
3.  On the Right side **Test Your Agent** section, click on Phone Call and choose your Scenario **(Inbound or Outbound).** Proceed to **Select Caller ID** (the number the agent will use to call you).  
...
You can also test a Voice AI agent while you are creating it. In the Create Agent flow, use the Test Your Agent panel on the Phone & Availability step to run the same Web Call and Phone Call trials described above. These test calls behave the same way as other trials, including Call History, transcripts, recordings, and summaries. 

  

For more details on configuring your agent during creation, refer to [Creating Voice AI Agents](https://help.gohighlevel.com/support/solutions/articles/155000004107-creating-voice-ai-agents)  
...
-   **Where to find:** From the **Test Your Agent**, open **Call History** or go to **Voice AI → Dashboards & Logs** and filter by **Call Type: Test**  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061010675/original/Jf_P_UWYIhmlxdVZqgrc9cIK3tg_SkGDvw.png?1766150359)  
...
The Outbound Scenario appears only when your sub-account is approved for Voice AI outbound calling and compliance. If you do not see this option, go to **AI Agents → Voice AI,** click **Enable Outbound Calls**, and complete the registration.  
...
| Field | Description |
| --- | --- |
| Scenario | Shows whether the call ran as **Inbound** or **Outbound**, so you can compare behaviours across different call directions. |
