---
title: "Workflow Trigger - Opportunity Changed"
url: "https://help.gohighlevel.com/support/solutions/articles/155000000886-workflow-trigger-opportunity-changed"
...
-   **Flexible Filter Operators**: Use "Has Changed," "Has Changed To," and "Equals"
    
    operators to precisely control when workflows trigger, similar to the Contact Changed
...
**• Has** **Changed**: Triggers when the assigned user changes to any other user.  
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695015/original/oX8LId93YSrM_6h6ypg_ETg4eWeCctBMlg.png?1768460530)
...
Use Tag filters to control when Opportunity Changed should fire based on opportunity tags.

  

The  Tag filter allows you to trigger a workflow based on tags assigned to an opportunity. This filter ensures that automation is only activated when an opportunity contains a specific tag, providing more control over workflow execution.
...
### ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155065759707/original/PBNHetgQ1i_K8kTPAQ6RXumtFW0ICqat5Q.png?1772099697)
...
• **Has Changed** **To**: Triggers only when the opportunity moves to a specific pipeline
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695255/original/6UdEe0QrbHEr2aOpUhHDq-BaGS0-BC_2AA.png?1768460744)
...
**Equals**: Triggers when any change occurs on opportunities that have a specific lost

reason assigned.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695321/original/WJ4n2v2MIVa3EbDV3y1zwASjldc5TKlbDA.png?1768460799)
...
**Has Changed To**: Triggers only when the status changes to a specific value you
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695356/original/QSRtNo9GVMrX3r5t6KkZj-noHgIHJ3Y7uA.png?1768460850)

  

  

**Checkbox Fields ( Opportunity Custom Field Filters )** 

  

Filter opportunities based on checkbox custom field changes.

  

• Added: Triggers when specific checkbox options are added/checked.

  

• Removed: Triggers when specific checkbox options are removed/unchecked.

  

• Equals: Triggers when any change occurs on opportunities where the checkbox
...
**Radio Select Fields ( Opportunity Custom Field Filters )** 

  
Filter opportunities based on radio select custom field changes.  
...
• Equals: Triggers when any change occurs on opportunities where the radio select

equals a specific value .  
  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695732/original/UBngab81d1sn2Uge0-rSxbkzI-FuyYLBPQ.png?1768461203)

  
  

**Dropdown Fields (Single & Multiple in Opportunity Custom Field Filters)**

  

Filter opportunities based on dropdown custom field changes. Works the same for both
...
• Has Changed To: Triggers only when the dropdown changes to specific values you

select.  
  

• Equals: Triggers when any change occurs on opportunities where the dropdown

equals specific values.  
  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155062695762/original/TDVBnoOy2xQFQ2d9s9LpsZsbJZhnRyGM_g.png?1768461247)

  
  

**Date Fields** **( Opportunity Custom Field Filters )**

  

Date custom fields are now available as filters in the Opportunity Changed trigger.
...
• Has Changed To: Triggers only when the date field changes to a specific date you

select.

  

• Equals: Triggers when any change occurs on opportunities where the date field
...
**Q: What is the difference between "Has Changed," "Has Changed To," and "Equals"**

**operators?**

"Has Changed" triggers when that particular field value changes to anything. "Has Changed To" triggers

only when a field changes to a specific value you select. "Equals" triggers when any change

happens to an opportunity that currently has that specific field value.

  

**Q: Can I use date custom fields as filters now?**

Yes! Date custom fields are now available as filters in the Opportunity Changed trigger. You

can use "Has Changed," "Has Changed To," or "Equals" operators to trigger workflows
