---
title: "How to Package Add-Ons as Part of SaaS Plans"
url: "https://help.gohighlevel.com/support/solutions/articles/155000007221-how-to-package-add-ons-as-part-of-saas-plans"
...
-   [Before You Begin: How Add-Ons Are Billed](#Before-You-Begin%3A-How-Add-Ons-Are-Billed)
    -   [1\. Reselling (NOT used inside SaaS plans)](#1.-Reselling-\(NOT-used-inside-SaaS-plans\))
    -   [2\. Direct Deployment (Used for SaaS plans)](#2.-Direct-Deployment-\(Used-for-SaaS-plans\))
-   [1\. Open the Add-Ons Section in SaaS Configurator](#1.-Open-the-Add-Ons-Section-in-SaaS-Configurator)
-   [2\. Choose Add-Ons to Include in the Plan](#2.-Choose-Add-Ons-to-Include-in-the-Plan)
-   [3\. Review Your Total Add-On Cost (Dynamic Calculator)](#3.-Review-Your-Total-Add-On-Cost-\(Dynamic-Calculator\))
-   [4\. Set Your SaaS Plan Price Accordingly](#4.-Set-Your-SaaS-Plan-Price-Accordingly)
-   [5\. What Happens When a Sub-Account Subscribes](#5.-What-Happens-When-a-Sub-Account-Subscribes)
-   [6\. Best Practices When Packaging Add-Ons](#6.-Best-Practices-When-Packaging-Add-Ons)
-   [7\. Summary](#7.-Summary)
...
**Important:** Add-on costs are _always_ billed to the agency when included inside SaaS plans.  
...
✔ Sub-accounts are _not_ billed individually
...
[How to Resell Marketplace Apps as a Part of SaaS Plans](https://help.gohighlevel.com/en/support/solutions/articles/155000006142-how-to-resell-marketplace-apps-as-a-part-of-saas-plans)