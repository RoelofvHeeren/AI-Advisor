---
title: "Calendly to HighLevel (Migration Guide)"
...
-   [Migrate Calendars (Event Types)](#Migrate-Calendars-\(Event-Types\))
-   [Migrate Workflows (Automations)](#Migrate-Workflows-\(Automations\))
...
**Can I use the same Calendly account in multiple HighLevel subaccounts while I migrate?**

Yes. You can connect the same Calendly account in each HighLevel subaccount you belong to. Each user can still connect only one Calendly account per subaccount.