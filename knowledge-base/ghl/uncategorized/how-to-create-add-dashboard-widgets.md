---
title: "How to Create & Add Dashboard Widgets"
...
Choosing the right visualization makes trends easier to spot and speeds up analysis. Select your chart type directly in **Configure** without leaving the edit flow.
...
1.  Open the widget editor and go to Configure.  
      
    
2.  Use **Chart Type** to pick a visualization (bar, line, pie, etc.).  
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064230676/original/gRwnqr0_ndcKaPpRTmyVj-exXVsnr91jyg.png?1770276704)
3.  Review the **live preview** and adjust as needed, then continue to Conditions or Save.
