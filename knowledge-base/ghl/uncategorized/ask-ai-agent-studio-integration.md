---
title: "Ask AI + Agent Studio Integration"
...
Yes. Ask AI uses the agent’s Production version. To update behavior, make changes in Staging, then promote the updated version to Production. No remapping is needed after promotion.
