---
title: "Workflows- Improved Execution Logs & Enrollment History"
...
-   [](#Where-to-Find-Execution-Logs-&-Enrollment-History?)[Where to Find Execution Logs & Enrollment History?](#Where-to-Find-Execution-Logs-&-Enrollment-History?)[](#Open-a-specific-execution-from-message-details-\(deep-link\))
-   [Open a specific execution from message details (deep link)](#Open-a-specific-execution-from-message-details-\(deep-link\))[](#Execution-Logs---UI/UX-Changes)
-   [Execution Logs - UI/UX Changes](#Execution-Logs---UI/UX-Changes)
-   [Enrollment History - UI/UX Changes](#Enrollment-History---UI/UX-Changes)
-   [Date and Time Enhancements](#Date-and-Time-Enhancements)
-   [Related Articles](#Related-Articles)[](#Where-to-Find-Execution-Logs-&-Enrollment-History?)
