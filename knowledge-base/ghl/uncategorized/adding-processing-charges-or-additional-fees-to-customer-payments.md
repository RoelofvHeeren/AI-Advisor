---
title: "Adding Processing Charges or Additional Fees to Customer Payments"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005519-adding-processing-charges-or-additional-fees-to-customer-payments"
category: "Uncategorized"
---

# Adding Processing Charges or Additional Fees to Customer Payments
...
-   [What is the Processing Charge Feature in HighLevel?](#What-is-the-Processing-Charge-Feature-in-HighLevel?)[](#Where-Does-This-Fee-Apply?)
-   [Where Does This Fee Apply?](#Where-Does-This-Fee-Apply?)[](#Important-Behavior-Guidelines)
-   [Important Behavior Guidelines](#Important-Behavior-Guidelines)[](#How-to-Configure-a-Processing-Charge)
-   [How to Configure a Processing Charge](#How-to-Configure-a-Processing-Charge)[](#Viewing-Processing-Charges-in-Checkouts)
-   [Viewing Processing Charges in Checkouts](#Viewing-Processing-Charges-in-Checkouts)[](#Viewing-Processing-Charges-in-Reports)
-   [Viewing Processing Charges in Reports](#Viewing-Processing-Charges-in-Reports)[](#Frequently-Asked-Questions)
...
(**Subtotal - Discounts + Taxes + Shipping**) - For E-commerce.
...
**IMPORTANT**: This feature is unavailable for PayPal & Custom Payment Providers, except in case of Invoices where it would work for all payment providers.

  

1.  E-commerce Stores. (Doesn't apply to E-commerce upsell products)  
...
-   Doesn't apply to E-commerce upsell products.  
...
2.  Define a **custom label/name** for the fee (e.g., Convenience Fee, Processing Charge, etc.). This label/name will appear on the customer’s checkout summary and receipt.  
      
    
3.  Enter the **fee percentage** to be applied (e.g., 2.5%).
...
**Note:** It is your responsibility to comply with applicable laws concerning surcharging as it may be prohibited in certain jurisdictions.

  

1.  Use the available checkboxes to choose where the processing charge should apply:  
...
2.  Select **one** or **multiple** options as needed.  
      
    
3.  Click **Save** to confirm the configuration. The processing charge will be applied automatically on the selected payment sources at checkout.
...
## **Troubleshooting: Processing Charge Not Showing On Invoices**  

1.  **Confirm the invoice channel:** In **Payments → Settings → Miscellaneous Charges**, make sure **Invoices & Estimates** is checked and you clicked **Save**.  
...
2.  **Check where you are looking on the invoice:** For invoices, the processing charge displays **after the customer clicks the Pay button** (it may not appear on the invoice preview before checkout).  
      
    
3.  **If it’s a draft invoice created earlier, edit it once:** Draft invoices show the processing charge **only if the invoice is edited after the feature is enabled**.  
      
    
4.  **If the invoice was already sent before you enabled the feature, it won’t update:** Invoices already sent (or orders already placed) before enabling the processing charge remain unaffected.  
      
    
5.  **Confirm the customer is paying from a supported experience:** Processing charges **do not apply to invoices paid via the mobile app**.  
      
    
6.  **Quick validation test:** Create a brand-new test invoice after enabling the feature, open the invoice link as the customer, click **Pay**, and confirm the processing charge line item appears in the checkout total.
