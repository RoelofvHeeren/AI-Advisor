---
title: "Workflow Action - DND Contact"
...
-   [What is DND Contact Workflow Action?](#What-is-DND-Contact-Workflow-Action?)
-   [Action Name](#Action-Name)
    -   [DND Contact](#DND-Contact)
    -   [Action Description](#Action-Description)
-   [How to Setup DND Contact Workflow Action](#How-to-Setup-DND-Contact-Workflow-Action)
-   [Some Triggers which can be used with the action (But not limited to)](#Some-Triggers-which-can-be-used-with-the-action-\(But-not-limited-to\))
-   [Logging and attribution](#Logging-and-attribution)
-   [Example](#Example)[](#Related-Articles)
...
<table border="1" cellpadding="0" cellspacing="0" data-sheets-baot="1" data-sheets-root="1" dir="ltr" style="table-layout: fixed; font-size: 10pt; font-family: Arial, Helvetica, sans-serif; width: 0px; border-collapse: collapse; border: none;"><colgroup><col width="100"><col width="506"><col width="119"></colgroup><tbody><tr style="height: 21px;"><td dir="ltr" style="border: 1px solid rgb(0, 0, 0); overflow: hidden; padding: 2px 3px; text-align: center;"><span style="font-family: Arial,Helvetica,sans-serif;"><strong dir="ltr">Field Name</strong></span></td><td dir="ltr" style="border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(204, 204, 204); border-image: initial; overflow: hidden; padding: 2px 3px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; text-align: center;"><span style="font-family: Arial,Helvetica,sans-serif;"><strong dir="ltr">Description</strong></span></td><td dir="ltr" style="border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(204, 204, 204); border-image: initial; overflow: hidden; padding: 2px 3px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; text-align: center;"><span style="font-family: Arial,Helvetica,sans-serif;"><strong>Mandatory</strong></span></td></tr><tr style="height: 21px;"><td dir="ltr" style="border-width: 1px; border-style: solid; border-color: rgb(204, 204, 204) rgb(0, 0, 0) rgb(0, 0, 0); border-image: initial; overflow: hidden; padding: 2px 3px; overflow-wrap: break-word;"><span style="font-family: Arial,Helvetica,sans-serif;">Mark as Read or Unread</span></td><td dir="ltr" style="border-width: 1px; border-style: solid; border-color: rgb(204, 204, 204) rgb(0, 0, 0) rgb(0, 0, 0) rgb(204, 204, 204); border-image: initial; overflow: hidden; padding: 2px 3px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; overflow-wrap: break-word;"><span style="font-family: Arial,Helvetica,sans-serif;">Choose to mark the conversation as either read or unread. Options include: None. Mark as Read. Mark as Unread</span></td><td dir="ltr" style="border-width: 1px; border-style: solid; border-color: rgb(204, 204, 204) rgb(0, 0, 0) rgb(0, 0, 0) rgb(204, 204, 204); border-image: initial; overflow: hidden; padding: 2px 3px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; overflow-wrap: break-word;"><span style="font-family: Arial,Helvetica,sans-serif;">No</span></td></tr></tbody></table>
