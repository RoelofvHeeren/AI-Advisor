---
title: "How to Set Up an E-Commerce Online Store (Websites)"
url: "https://help.gohighlevel.com/support/solutions/articles/155000001157-how-to-set-up-an-e-commerce-online-store-websites-"
...
-   [BNPL (Buy Now Pay Later) Payment Methods](#BNPL-\(Buy-Now-Pay-Later\)-Payment-Methods)
...
**Tip:** In the Store Builder, certain Store elements support direct item selection on the canvas. For **Featured Product** and **Collections List**, you can **double-click** an item to map or review it—unmapped items open the selection drawer automatically, and mapped items highlight for quick confirmation.
