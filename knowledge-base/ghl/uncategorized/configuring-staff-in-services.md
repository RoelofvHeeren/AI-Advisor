---
title: "Configuring Staff in Services"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005331-configuring-staff-in-services"
...
-   [Overview of Configuring Staff in Services](#Overview-of-Configuring-Staff-in-Services)
-   [Key Benefits of Configuring Staff](#Key-Benefits-of-Configuring-Staff)
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052231637/original/4a92J7kcpeNS0M9wSRCNvrACKvwksnVlnA.png?1756023697)
...
#### **5\. Add Date-Specific Hours for Multiple Dates:**

When you need the same hours across several days (for example, holiday hours), you can apply date-specific hours in bulk:

-   In the Date-Specific Hours tab, select multiple dates in the date picker.  
      
    
-   Set the start time and end time.  
      
    
-   Select the services and locations you want these hours to apply to.  
      
    
-   Apply the changes to add the same date-specific hours across all selected dates.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064120872/original/5W1FiVGovG6x79rABQ9lo6SCZgm-SdwrNw.png?1770142480)

#### **How date grouping works:**

After you apply date-specific hours in bulk, HighLevel groups the dates to keep the list easier to manage:

-   Consecutive dates are grouped into one entry.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064121270/original/n3Zbhm2Xw_7mU3BfsVCK-DdeYpzDe4seiw.png?1770142994)
...
-   [Global Settings in Services](https://help.gohighlevel.com/en/support/solutions/articles/155000003546)[](https://help.gohighlevel.com/en/support/solutions/articles/155000005330)  
