---
title: "Shopping Cart Mode in One and Two-step Order forms (V2 Funnels only)"
...
#### [How to set up a Product and Price Description **(Video)**](#How-to-set-up-a-Product-and-Price-Description-\(Video\))  
...
[How to sell multiple quantities of items? **(Video)**](#How-to-sell-multiple-quantities-of-items?-\(Video\))
