---
title: "How to Use Opportunity Notes?"
...
**_Example scenario:_** John Doe (a contact) has two opportunities for 2 different real estate properties- Property A and Property B. Sara (the Sales Agent & GHL Admin) managing the properties for John Doe wants to create specific notes for each opportunity to keep relevant information tied to each property’s opportunity only.
