...
-   [What are Voice AI Custom Actions?](#What-are-Voice-AI-Custom-Actions?)[](#Key-Benefits-of-Voice-AI-Custom-Actions)
-   [Key Benefits of Voice AI Custom Actions](#Key-Benefits-of-Voice-AI-Custom-Actions)[](#Voice-AI%C2%A0Conversation-Triggers)
-   [Voice AI Conversation Triggers](#Voice-AI%C2%A0Conversation-Triggers)[](#Webhook-Custom-Action)
-   [Webhook Custom Action](#Webhook-Custom-Action)[](#Dynamic-Parameter-Collection)
-   [Dynamic Parameter Collection](#Dynamic-Parameter-Collection)[](#How-to-Set-Up-Voice-AI-Custom-Actions)
-   [How to Set Up Voice AI Custom Actions](#How-to-Set-Up-Voice-AI-Custom-Actions)
    -   [Step 1: Navigate to your Voice AI Agent](#Step-1%3A%C2%A0Navigate-to-your-Voice-AI-Agent)
    -   [Step 2: Create Custom Action](#Step-2%3A-Create-Custom-Action)
    -   [Step 3: Configure Custom Action](#Step-3%3A%C2%A0Configure-Custom-Action)[](#Voice-AI--%C2%A0Real-time-Testing)
-   [Voice AI - Real-time Testing](#Voice-AI--%C2%A0Real-time-Testing)[](#Frequently-Asked-Questions)
