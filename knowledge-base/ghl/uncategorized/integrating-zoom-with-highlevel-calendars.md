---
title: "Integrating Zoom with HighLevel Calendars"
url: "https://help.gohighlevel.com/support/solutions/articles/155000002372-integrating-zoom-with-highlevel-calendars"
...
**Note**: Dynamic Zoom links are only available for Personal, Round Robin, Service and Collective Calendars.
...
-   **Multi-Location & Multi-User Sharing:** You can connect the same Zoom account across multiple locations and allow multiple users to use that same Zoom account for bookings.  
      
    To connect Zoom using the latest Connections flow, go to:  
      
    Calendars → Settings → Connections → Video Conferencing → Add New → Zoom  
      
    For step-by-step setup and admin scenarios, see “[Zoom Integration for Users’ Calendar Bookings](https://help.gohighlevel.com/en/support/solutions/articles/48001179593-zoom-integration-for-users-calendar-bookings).”  
...
If Zoom is disconnected and later reconnected, HighLevel automatically generates Zoom links for **upcoming appointments** that were created during the downtime and were missing links, so you don’t have to update each appointment manually.
...
Yes, you can use both Zoom and Google Meet at the same time provided both are connected in the integrations. Howonly one video conferencing platform can be active per user profile or calendar at a time.  
...
Personal Booking, round robin, service calendars and collective calendars support Zoom integration and generate new Zoom links for each appointment booked.
