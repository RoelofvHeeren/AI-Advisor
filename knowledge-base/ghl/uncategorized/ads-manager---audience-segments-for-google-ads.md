---
title: "Ads Manager - Audience Segments for Google Ads"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006800-ads-manager-audience-segments-for-google-ads"
category: "Uncategorized"
---

# Ads Manager - Audience Segments for Google Ads
...
-   [What is Audience Segments for Google Ads?](#What-is-Audience-Segments-for-Google-Ads?)[](#Key-Benefits-of-Audience-Segments-for-Google-Ads)
-   [Key Benefits of Audience Segments for Google Ads](#Key-Benefits-of-Audience-Segments-for-Google-Ads)[](#Audience-Segments)
-   [Audience Segments](#Audience-Segments)[](#How-to-Create-an-Audience-Segment)
-   [How to Create an Audience Segment](#How-to-Create-an-Audience-Segment)[](#Segment-Types)
-   [Segment Types](#Segment-Types)[](#1.-Customer-Match)
    -   [1\. Customer Match](#1.-Customer-Match)[](#2.-Website-Visitors)
    -   [2\. Website Visitors](#2.-Website-Visitors)[](#3.-Interest-Segments)
    -   [3\. Interest Segments](#3.-Interest-Segments)[](#4.-Lookalike-Segments)
    -   [4\. Lookalike Segments](#4.-Lookalike-Segments)[](#How-to-Use-Audience-Segments-in-Google-Ad-Campaigns)
-   [How to Use Audience Segments in Google Ad Campaigns](#How-to-Use-Audience-Segments-in-Google-Ad-Campaigns)[](#What-are-Target-Interests-\(Affinity-and-In-Market-Audiences\))
-   [What are Target Interests (Affinity and In-Market Audiences)](#What-are-Target-Interests-\(Affinity-and-In-Market-Audiences\))[](#1.-Affinity-Audiences)
    -   [1\. Affinity Audiences](#1.-Affinity-Audiences)[](#2.-In-Market-Audiences)
    -   [2\. In-Market Audiences](#2.-In-Market-Audiences)[](#Affinity-vs.-In-Market-Comparison)
-   [Affinity vs. In-Market Comparison](#Affinity-vs.-In-Market-Comparison)[](#Combining-Segments-and-Target-Interests)
-   [Combining Segments and Target Interests](#Combining-Segments-and-Target-Interests)[](#Best-Practices-to-Maximize-ROI)
-   [Best Practices to Maximize ROI](#Best-Practices-to-Maximize-ROI)[](#Common-Limitations)
-   [Common Limitations](#Common-Limitations)[](#Frequently-Asked-Questions)
...
1.  Click on **Marketing** > **Ad Manager** from your sub-account.  
      
    ![](https://jumpshare.com/share/IIzhAYjAivh9gpmWqZzQ+/Screen+Shot+2025-11-13+at+8.40.44+PM.png)  
      
    
2.  Click on the **Settings** button.  
      
    ![](https://jumpshare.com/share/CGruKb8MsPSYgiLg0hJt+/Screen+Shot+2025-11-13+at+8.43.15+PM.png)  
      
    
3.  Go to **Google Ads > Audience Segments** tab.  
      
    ![](https://jumpshare.com/share/UBI2tuHlhSCtHa0PMvT8+/Screen+Shot+2025-11-13+at+8.47.00+PM.png)  
      
    
4.  Click **\+ Create New Segment** button.  
      
    ![](https://jumpshare.com/share/tKSbu1TUusrtzo6lGX9J+/Screen+Shot+2025-11-13+at+8.48.42+PM.png)  
      
    
5.  Choose a **Segment** **Type** (Customer Match, Website Visitors, Interest, or Lookalike).  
      
    
6.  Click on **Next**.  
      
    ![](https://jumpshare.com/share/jVlliTwgAAEeRb3nMxDA+/Screen+Shot+2025-11-13+at+8.50.33+PM.png)  
      
    
7.  Configure details based on the segment type (outlined below).  
...
1.  Choose **Customer** **Match**.  
      
    
2.  Upload a **CSV** file. 
3.  or select a **Smart** **List** for dynamic syncing.  
      
    
4.  Set **Membership** **Duration** (up to 540 days).  
      
    
5.  Confirm data compliance with Google’s [Customer Match Policy](https://support.google.com/adspolicy/answer/6299717?hl=en).  
      
    
6.  **Name** and **Create** the segment.  
      
    

![](https://jumpshare.com/share/qAmIkElVnYN0l8H6ij11+/GIF+Recording+2025-11-13+at+9.09.56+PM.gif)
...
1.  Choose **Website****Visitors**.  
      
    
2.  Define **conditions** (e.g., “Visited /checkout” page).  
      
    
3.  Set the **time window for tracking** (e.g., last 30 days).  
      
    
4.  Combine multiple rules using **AND/OR** logic.  
...
### ![](https://jumpshare.com/share/cUgN1t61zpmy4hPGwvMW+/Screen+Shot+2025-11-13+at+9.14.55+PM.png)
...
1.  Choose **Interest Segments**.  
      
    
2.  **Name** the segment.  
      
    
3.  Add **Interest** or **Behavior**.  
...
6.  **Create** the segment.

  

![](https://jumpshare.com/share/8Pa8hDx5F07HczVhH5Aj+/GIF+Recording+2025-11-13+at+9.31.46+PM.gif)
...
1.  Choose **Lookalike** **Segment**.  
      
    
2.  Add segment **Name**.  
      
    
3.  Select up to **10 seed lists**.  
      
    
4.  Choose target **countries**.  
      
    
5.  Define **reach** **size** : **Narrow** (2.5%), **Balanced** (5%) or **Broad** (10%).  
...
![](https://jumpshare.com/share/78sZaDL3HH8vPW8SaYs3+/GIF+Recording+2025-11-13+at+9.48.04+PM.gif)
...
1.  Go to **Marketing** **\>** **Ad Manager** **\>** **\+ Create Campaign**  
      
    
2.  Choose **Google** as the platform and click on **Next**.  
      
    
3.  Create a campaign from **Scratch** or choose from **Templates**.  
      
    
4.  Go to the **Intended** **Audience** section.  
      
    
5.  Select **Audience** **Segments** tab.  
      
    
6.  Pick **existing segments** or click **\+ Create a New Audience Segment** to build one inline.

  
![](https://jumpshare.com/share/aRvIWQIUqOStJQnWzB2l+/GIF+Recording+2025-11-13+at+9.52.16+PM.gif)
...
![](https://jumpshare.com/share/eJwI6BA0mLuqCzBcAHtL+/GIF+Recording+2025-11-13+at+10.00.46+PM.gif)
...
![](https://jumpshare.com/share/wAknQFZuFo8fFEQVn3gY+/GIF+Recording+2025-11-13+at+10.04.21+PM.gif)
...
-   [Overview of Ad Manager](https://help.gohighlevel.com/en/support/solutions/articles/155000002433)  
    ...
    [](https://help.gohighlevel.com)[](https://help.gohighlevel.com/en/support/solutions/articles/155000004542)
...
-   [Carousel ads in Ad Manager](https://help.gohighlevel.com/en/support/solutions/articles/155000003660)