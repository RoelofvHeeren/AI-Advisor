---
title: "How to set up and use the Voice AI Chat Widget"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006648-how-to-set-up-and-use-the-voice-ai-chat-widget"
...
-   [Overview](#Overview)
-   [What the Voice AI Chat Widget does](#What-the-Voice-AI-Chat-Widget-does)
-   [Key Capabilities](#Key-Capabilities)
-   [Enabling the Voice AI Chat Widget](#Enabling-the-Voice-AI-Chat-Widget)
    -   [Step 1: Enable from Labs](#Step-1%3A-Enable-from-Labs)
    -   [Step 2: Configure the Widget](#Step-2%3A-Configure-the-Widget)
    -   [Step 3: Add the widget to a website or funnel](#Step-3%3A-Add-the-widget-to-a-website-or-funnel)
    -   [Step 4: How visitors interact](#Step-4%3A%C2%A0How-visitors-interact)
-   [Best Practices](#Best-Practices)
-   [Security and Compliance](#Security-and-Compliance)
-   [Troubleshooting](#Troubleshooting)
-   [Example: Setting up for lead capture](#Example%3A-Setting-up-for-lead-capture)
