---
title: "How to Add Product Weights, Dimension, and SKU Information in Your Ecom Store"
...
Prices/Variants are now easier to discover and manage from the pricing/variant list:

**Hover Highlight:** Price/Variant tiles highlight on hover to make it clear they are clickable and open the detailed Price/Variant page (where you can add weight, dimensions, SKU, inventory, and digital files).

**Quick Actions:** Each tile includes Edit and Delete options for faster management without opening the full detail page.
