---
title: "Ad Manager - Configure Google Ads Additional Assets at Campaign Level"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005789-ad-manager-configure-google-ads-additional-assets-at-campaign-level"
...
-   [What is Campaign‑Level Google Ads Additional Assets?](#What-is-Campaign%E2%80%91Level-Google-Ads-Additional-Assets?)[](#Additional-Asset-Limits)
-   [Additional Asset Limits](#Additional-Asset-Limits)[](#Key-Benefits-of-Campaign%E2%80%91Level-Additional-Assets)
-   [Key Benefits of Campaign‑Level Additional Assets](#Key-Benefits-of-Campaign%E2%80%91Level-Additional-Assets)[](#How-to-Configure-Google-Ads-Additional-Assets-at-Campaign-Level)
-   [How to Configure Google Ads Additional Assets at Campaign Level](#How-to-Configure-Google-Ads-Additional-Assets-at-Campaign-Level)[](#Fallback-Logic)
-   [Fallback Logic](#Fallback-Logic)[](#Frequently-Asked-Questions)
...
| **Image Assets** | JPG, PNG | 1:1 (square), 1.91:1 (landscape) | Up to 20 images | Max file size: 5 MB per image. Recommended: 2–3 per ratio |
| **Call Extensions** | Phone numbers | N/A | Multiple | Must be Google-approved |
| **Sitelinks** | Text + URL | N/A | 2–20 (recommended 4) | Supports descriptions (optional) |
...
-   In the Additional Assets section, click **Upload****Images**.  
...
-   **Supported Guidelines:**  
    -   **Formats**: JPG, PNG
    -   **Aspect****Ratios**: 1:1 (square) and 1.91:1 (landscape)
    -   **File****Size**: Up to 5 MB per image
...
**Learn** **more** on how to **create a 'Call from ads'** conversion action [**here**](https://support.google.com/google-ads/answer/6095882#).
...
Adding images makes your Search ads more eye-catching across Google surfaces. Upload brand-safe visuals once and let Google place them where they perform best.

  

**Specifications**

**Quantity**: up to 20 images per campaign  

**Formats**: JPG, PNG

**Aspect ratios:** Square (1:1) and Landscape (1.91:1) only  
...
1.  In the campaign builder, open Image Assets.  
      
    
2.  Click Upload and select your images.  
      
    
3.  Confirm each file meets the ratio and size requirements.  
...
Behavior: Google automatically selects relevant images for placements across **Search**, **Display**, and **YouTube**. If some images fail checks, your text ads still publish.

### **Validation & Errors**

-   The builder shows clear messages for policy, aspect-ratio, or file-size issues.  
      
    
-   Failed assets are skipped; valid assets remain eligible.

  

**Best Practices**

-   Add 2–3 images per ratio to maximize coverage.  
      
    
-   Avoid heavy text overlays, watermarks, GIFs, or misleading content.  
      
    
-   Use crisp, uncluttered imagery that complements headlines/descriptions.
...
**Note:** Learn more about account-level assets: [Google Ads Support](https://support.google.com/google-ads/answer/7175034) 
...
-   [Create a new Google Search Ad Campaign](https://help.gohighlevel.com/en/support/solutions/articles/155000004543)  
