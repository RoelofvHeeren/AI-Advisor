...
url: "https://help.gohighlevel.com/support/solutions/articles/155000006082-interactive-whatsapp-messages"
...
-   [What are Interactive WhatsApp Messages?](#What-are-Interactive-WhatsApp-Messages?)
-   [Key Benefits of Interactive WhatsApp Messages](#Key-Benefits-of-Interactive-WhatsApp-Messages)
-   [Prerequisites: Customer Service Window](#Prerequisites%3A-Customer-Service-Window)
    -   [How to Check or Trigger the Customer Service Window](#How-to-Check-or-Trigger-the-Customer-Service-Window)
-   [How to add the WhatsApp Interactive Messages Action](#How-to-add-the-WhatsApp-Interactive-Messages-Action)
    -   [Interactive Reply Buttons (Interactive Message Type)](#Interactive-Reply-Buttons%C2%A0\(Interactive-Message-Type\))
    -   [Location (Interactive Message Type)](#Location-\(Interactive-Message-Type\))
    -   [Contact (Interactive Message Type)](#Contact%C2%A0\(Interactive-Message-Type\))
    -   [List (Interactive Message Type)](#List%C2%A0\(Interactive-Message-Type\))
    -   [Interactive Call-to-Action (Visit Website) URL Button Messages](#Interactive-Call-to-Action-\(Visit-Website\)-URL-Button-Messages)[](#Example-URL-with-CRM-Variables)
    -   [Example URL with CRM Variables](#Example-URL-with-CRM-Variables)[](#Example-Button-Setup-in-Workflow)
    -   [Example Button Setup in Workflow](#Example-Button-Setup-in-Workflow)[](#Branching-&-Workflow-Behavior)
    -   [Branching & Workflow Behavior](#Branching-&-Workflow-Behavior)
...
####   
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155052286891/original/3p45ZiR6nSp7HO_6m0HuAiT8noU3aMYSXw.png?1756120926)  
...
_Tip: Always double-check coordinates match your business address to avoid confusion._
...
<table class="fr-no-borders" style="width: 100%;"><tbody><tr><td style="width: 50.0000%;"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155057874072/original/6brNPbS8T0q-ZhBmH6H4YCpfCfxRY4Tqdw.png?1762550971" style="width: 268px; max-width: 100%; display: block; float: none; vertical-align: top; margin: 5px auto; text-align: center;" class="fr-dib fr-bordered" data-attachment="[object Object]" data-id="155057874072"></td><td style="width: 50.0000%;"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155057874080/original/ueMfiC4y8-l88Wg7aTBVRU2rGIjATSDlEA.png?1762550994" class="fr-dib fr-bordered" style="box-sizing: content-box; border: 1px solid rgb(204, 204, 204); max-width: 100%; cursor: pointer; padding: 0px 1px; margin-bottom: 5px; margin-left: auto; display: block; color: rgb(0, 0, 0); font-family: Arial, sans-serif; font-size: 13px; font-weight: 400; text-indent: 0px; width: 204px; text-align: center;" data-attachment="[object Object]" data-id="155057874080"></td></tr></tbody></table>
...
-   **URL**: `[https://mybusiness.com/booking?name={{contact.name}}](https://mybusiness.com/booking?name={{contact.name}})`
