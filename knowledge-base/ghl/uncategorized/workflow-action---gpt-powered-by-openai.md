---
title: "Workflow Action - GPT Powered by OpenAI"
url: "https://help.gohighlevel.com/support/solutions/articles/155000000209-workflow-action-gpt-powered-by-openai"
...
**IMPORTANT**: For pricing of GPT-4 refer to [GPT-4 in HighLevel](https://help.gohighlevel.com/en/support/solutions/articles/155000002331). For pricing of GPT-5 refer to [GPT-5 in HighLevel](https://help.gohighlevel.com/en/support/solutions/articles/155000005919).
...
**1\. Select Model:** Users will be able to select from a "Model" to select. By default, GPT 5 Mini will be selected but the users will have the option to select other GPT models as well including: 

  

GPT 5, GPT 5.1, GPT 5 Mini, GPT 5 Nano, GPT 4o, GPT 4 Turbo and GPT 4o Mini.

  

**![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155059931288/original/K1DJ8Cmy-o4FU-0nHWAbIQODu4qJoGyZNg.png?1764874524)**
...
Generate email content without subject to promote the product in this link YOUR\_WEBSITE to {{contact.name}} from {{user.name}}
...
-   [GPT-5 in HighLevel Workflows](https://help.gohighlevel.com/en/support/solutions/articles/155000005919)  
      
    
-   [GPT-4 in HighLevel](https://help.gohighlevel.com/en/support/solutions/articles/155000002331)  
