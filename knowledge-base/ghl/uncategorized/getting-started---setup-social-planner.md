---
title: "Getting Started - Setup Social Planner"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005063-getting-started-setup-social-planner"
...
-   [Explore Social Planner](#Explore-Social-Planner)
-   [Setup and Connect social accounts (required to publish)](#Setup-and-Connect-social-accounts-\(required-to-publish\))
-   [Creating Posts Using Templates](#Creating-Posts-Using-Templates)
-   [Creating Custom Posts](#Creating-Custom-Posts)
-   [Add media, preview, and edit thumbnails](#Add-media,-preview,-and-edit-thumbnails)
...
You can start exploring Social Planner even if you have not connected any social accounts yet. This lets you preview key workflows and prepare content before you connect channels for publishing.

  
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155065399888/original/8vketQGOfOn0mmxEhrjt0nBymS7uF-uwaQ.png?1771640321)  

What you can do before connecting social accounts

  

From **Marketing > Social Planner,** you can access these features without connecting:

  

**Schedule a post**

Click **Schedule Now** to open the post composer and scheduling flow. You can draft content, review scheduling options, and see how multi-channel posting works.

  

**Bulk scheduling with CSV**

Click **Upload A CSV** to start the bulk upload flow. You can import posts in bulk, validate your file, and review the post list before scheduling.

  

**Evergreen Queue Post**

Click **Create Evergreen Post** to explore evergreen content planning. This helps you organize reusable posts and build a queue for ongoing publishing.

  

**Recurring Post**

Click **Create Recurring Post** to set up repeating content. This helps you plan posts that automatically repeat on a schedule for consistent engagement.

  

**Generate Feed from RSS Post**

Click **Create RSS Post** to add an RSS feed and review the automation setup. This helps you turn new RSS items into social posts to keep channels active.

* * *

## **Setup and Connect social accounts (required to publish)**

  

Let's get your accounts connected so you can start posting with ease. Here's how:  
  

1.  Choose the social account you want to connect by clicking its button. We’ll use Facebook as an example.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155065399910/original/1WkyMRGNei1nBrYG8Amnev9RPhj7zbbaeg.png?1771640559)  
...
3.  Choose at least one Facebook page you'd like to manage.  
...
## **Add media, preview, and edit thumbnails**

You can Add images or videos from the Media Library using the video and Image Icon on the Panel. When you add a video, you can Preview your media in the composer located at the left side. 

  

**Tip:** You can replace or edit media and keep it in the same position in the post’s media sequence. This helps you swap files without changing your layout.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064535499/original/3U-FILqZwZsOLe9Vdkn9t-Z_UNcY3QR09A.png?1770689786)

  

  

In order to edit a video thumbnail, click the pencil icon on the video thumbnail. (hover over the media for the edit option to appear.

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064535505/original/l4R1nEIUhKq2EJ5dSIsMfekX_WTUfV1wVQ.png?1770689802)
...
Click the custom thumbnail tab to upload an image.

  

**Currently, Custom Video Thumbnails are Supported for**  
  
1\. Facebook Pages  
2\. Instagram Business Account  
3\. LinkedIn Profiles and Pages  
4\. Youtube Video and Shorts

  

![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064535684/original/K69dRSIOlKbJQPcdrQna2-R3EVCJatSeyQ.png?1770690314)
