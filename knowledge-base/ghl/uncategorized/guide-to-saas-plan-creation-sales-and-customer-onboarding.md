---
title: "Guide to SaaS Plan Creation, Sales, and Customer Onboarding"
url: "https://help.gohighlevel.com/support/solutions/articles/155000003670-guide-to-saas-plan-creation-sales-and-customer-onboarding"
...
-   [Section 1: Setup your SaaS Configurator](#Section-1%3A-Setup-your-SaaS-Configurator)
    -   [Step 1: Select your Agency Sub-Account(s)](#Step-1%3A-Select-your-Agency-Sub-Account\(s\))
...
**Complimentary Credits (trial timing)**

  

If your plan includes complimentary credits, you can choose when credits are issued:

-   **Immediately upon sign-up** (default behavior), or
-   **After the trial period ends** using the “Add credits after trial period ends” toggle.

  

When enabled, credits are not issued during the trial. The first issuance happens on trial conversion, and recurring credits align to the billing cycle from that point forward.
