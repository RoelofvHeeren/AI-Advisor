---
title: "Printify Integration for Ecommerce Stores"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006595-printify-integration-for-ecommerce-stores"
...
-   [What is Printify Integration?](#What-is-Printify-Integration?)[](#Key-Benefits-of-Printify-Integration)
-   [Key Benefits of Printify Integration](#Key-Benefits-of-Printify-Integration)[](#Important-Notes-&-Limitations)
-   [Important Notes & Limitations](#Important-Notes-&-Limitations)[](#How-To-Generate-Printify-API-Token)
-   [How To Generate Printify API Token](#How-To-Generate-Printify-API-Token)[](#How-To-Connect-Printify-with-HighLevel)
-   [How To Connect Printify with HighLevel](#How-To-Connect-Printify-with-HighLevel)[](#Frequently-Asked-Questions)
...
1.  Log in to Printify and click on **Account**.  
      
    
2.  Click on **Connections.**  
      
    
3.  Click on the Generate button under **API Tokens**.  
      
    ![](https://jumpshare.com/share/U105nFY9b0MhE4HQt6nG+/Screen+Shot+2025-10-09+at+5.04.05+PM.png)  
      
    
4.  Name the token, select scopes, and click on **Generate**.  
      
    ![](https://jumpshare.com/share/63sQkEA5sAuHz8U9zD2c+/Screen+Shot+2025-10-09+at+5.08.30+PM.png)  
      
    
5.  Copy the key by clicking on **Copy to Clipboard**.  
      
    ![](https://jumpshare.com/share/aDZSEWopXynzDjjzFkUQ+/Screen+Shot+2025-10-09+at+5.09.24+PM.png)
...
1.  In your sub-account, open **App Marketplace**.  
      
    ![](https://jumpshare.com/share/UrEIyVGIqHEfB3XYCVvx+/Screen+Shot+2025-10-09+at+5.12.38+PM.png)  
      
    
2.  Search **Printify** and click on the **Install** button.  
      
    ![](https://jumpshare.com/share/IenovVwFcwvX3FM93Lvu+/SCR-20251006-moze.png)  
      
    
3.  Paste your **Printify** **API** **token** in the Printify Token box and click on **Continue**.  
      
    ![](https://jumpshare.com/share/hKr14Fg8eL06i8YqLpBC+/image+%282%29.png)  
      
    
4.  Choose an existing Printify store or create a new one and click on **Connect**.  
      
    
5.  Import products and publish them directly into your store.  
      
    
6.  Start selling — orders will sync automatically to Printify for fulfillment. Enable the automatic fulfilment in Printify.  
      
    ![](https://jumpshare.com/share/OBF8Ct54xT2VeUgg5ZT9+/image+%283%29+%281%29.png)
