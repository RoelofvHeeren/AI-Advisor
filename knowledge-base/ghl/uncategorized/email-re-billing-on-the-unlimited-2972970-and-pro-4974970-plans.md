---
title: "Email Re-Billing on the Unlimited (297/2970) and Pro (497/4970) Plans"
...
Forwarded messages are billed **per email** when **rebilling** is enabled, aligning forwarded usage with regular outgoing sends.
...
**How it appears on billing**

-   Charged at the same per-email rate used for standard email sends _(Needs Confirmation: confirm any plan-specific markup/fees)_  
      
    
-   Look for **Billing Source Type** and **Billing Trigger ID** in billing views to trace each forwarded-email event _(Needs Confirmation: exact surfaces—invoice line items, usage CSV, transactions table, notifications)_
