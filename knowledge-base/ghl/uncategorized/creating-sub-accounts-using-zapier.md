---
title: "Creating Sub-Accounts using Zapier"
...
### To create new subaccounts via Public API please make sure you're currently subscribed to the [ProPlan](https://help.gohighlevel.com/support/solutions/articles/48001208376#Q8\)-How-Do-I-Upgrade-my-HighLevel-Account?).[](https://help.gohighlevel.com/support/solutions/articles/48001208376#Q8\)-How-Do-I-Upgrade-my-HighLevel-Account?)
...
#### [Q1) When creating a user I do not receive a password, location or agency API in the Post results?](#Q1\)-When-creating-a-user-I-do-not-receive-a-password,-location-or-agency-API-in-the-Post-results?)

#### [Q2) My webhook is not firing from the workflow](#Q2\)-My-webhook-is-not-firing-from-the-workflow)
...
[](https://rest.gohighlevel.com/v1/locations)[https://rest.gohighlevel.com/v1/locations](https://rest.gohighlevel.com/v1/locations)
