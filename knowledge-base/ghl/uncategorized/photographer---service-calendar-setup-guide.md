---
title: "Photographer - Service Calendar Setup Guide"
...
-   [Creating Groups for Photography Services](#Creating-Groups-for-%E2%80%8BPhotography-Services)
...
Service Calendars are scheduling tools that let you define specific services, assign staff, and allocate resources like rooms and equipment. For a photography business, this means you can create calendars for services such as portrait sessions, event coverage, and studio shoots. Each linked to the right photographer, studio space, and gear. This ensures customers can book easily while your team avoids scheduling conflicts.
...
Service Calendars help **photography businesses** streamline scheduling, improve efficiency, and enhance customer experience.
...
-   **Resource Management**: Assign studio spaces and tools (cameras, lenses, lights) to prevent double bookings.

  

-   **Staff Scheduling**: Define photographers’ working hours for accurate availability.

  

-   **Service Grouping**: Organize offerings into groups like “Portraits & Events” or “Studio Sessions.”

  

-   **Flexible Menus**: Offer multiple services in one booking (e.g., portrait session + add-on headshots).
...
Adding staff is the foundation of service calendars since no service can be assigned without photographers set up.
...
Enter the photographer’s **name, email, extension**. Set **user permissions** (limit access if needed). Define **availability** (e.g., Mark works Mon, Wed, Fri, 9am–5pm; Henry works Tue–Sat, 11am–7pm). Click **Save**. 
...
## **Creating Groups for Photography Services**
...
In the **Calendars tab**, click **\+ New Group** on the left sidebar. Groups help you organize related services such as portraits, events, or studio sessions.
...
Select a group from the left sidebar and click **Create Calendar**. This begins the setup of a new service calendar for a specific photography service like a portrait session or event coverage.
...
Navigate to **Calendars → Service Menu → Create Service Menu**. From the list of calendar types, click **Service Booking**. This option is designed for service-based businesses like photography businesses, allowing clients to book specific services such as portrait sessions or event coverage.
...
Fill out the service details including **Service Name, Assigned Staff, Custom URL, Service Duration, and Availability**. This step ensures the calendar is tailored to the specific photography service being offered. Click **Advanced Settings** for further customization. 

  

Clicking **Advanced Settings** expands additional configuration panels like **Service Details, Availability, Forms & Payment, Notifications, Customizations, and Rooms & Equipment**. These options let you fine-tune the booking flow, add branding, manage payments, and assign resources such as studio spaces or gear.
...
In the **Service Details tab**, you define the information that customers will see when booking this service. Start by uploading a **Service Logo** to give the booking page a professional look. Enter a clear **Service Name** (e.g., Portrait Session, Headshots, Event Photography) and add a **Description** that explains what the service includes, such as “30-minute portrait session with light retouching.” 

  

Next, assign the service to the right **Group** (e.g., **Portraits & Events**) so it stays organized with related services. Finally, create a **Custom URL** — this becomes part of the booking link you’ll share with customers, making it easier to recognize and share (e.g., /portrait-session-booking).
...
In the **Rooms tab**, you connect a physical space in your **photography studio** to the service. A room can represent a studio room, set, or backdrop area where the service is performed. For example, you might assign “Studio Set 1” for portrait sessions and headshots, or “Cyclorama Wall” for product photography and finishing. Assigning a room ensures that once a customer books the service, that specific space or station is reserved and cannot be double-booked. This is especially useful for studios with limited shoot spaces, as it prevents multiple appointments from being scheduled in the same spot at the same time.
...
In the **Equipment tab**, you link the tools or resources needed to complete the service. Equipment can represent items like **cameras, lenses, tripods, or lighting kits,**, and you can specify the available quantity. For example, you may assign “Lighting Kit” to a studio portrait service or “Telephoto Lens” to an event photography service. When a customer books the service, the system automatically reserves the necessary equipment, making sure it isn’t overbooked across multiple appointments. This helps maintain smooth operations by guaranteeing that all required tools are available for every appointment.
...
Click **\+ Create Service Menu** in the top-right. This starts a new, customer-facing menu that will display your photography services.
...
Under **Additional Options**, toggle **Enable Add Guests**, **Enable Multiple Service Selection**, and **Enable Staff Selection**. These controls let customers book for guests, select multiple services (e.g., portrait session + add-on headshots), and pick a preferred photographer.
...
Open **Arrange your services**, then drag the handles to reorder how groups/services appear. Place your most popular items (e.g., Portrait Session, Headshots) at the top to improve conversions.
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155063324441/original/e8c6DR9HqTiRNF5AEmvy7D6jP6XrqYBcng.png?1769163558)
...
**Q: How do I prevent double-booking a studio space or equipment?  
**Assign rooms and equipment to each service.

  

**Q: Can clients pick their preferred** **photographer****?**
