---
title: "How to Bulk Manage SaaS Sub-accounts"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005270-how-to-bulk-manage-saas-sub-accounts"
category: "Uncategorized"
---

# How to Bulk Manage SaaS Sub-accounts
...
-   [How to Enable SaaS Mode in Bulk](#How-to-Enable-SaaS-Mode-in-Bulk)
    
    -   [Step 1: Select sub-accounts for bulk action](#Step-1%3A-Select-sub-accounts-for-bulk-action)
    -   [Step 2: Choose Payment Provider](#Step-2%3A%C2%A0Choose-Payment-Provider)
    -   [Step 3: Select SaaS Subscription Plan](#Step-3%3A%C2%A0Select-SaaS-Subscription-Plan)
    
-   [How to Pause Sub-Accounts in Bulk](#How-to-Pause-Sub-Accounts-in-Bulk)
    ...
    -   [Step 2: Set Pause Preferences](#Step-2%3A%C2%A0Set-Pause-Preferences)
    -   [Note: If you don’t disconnect LC Phone accounts, you may still be charged for usage.](#Note%3A-If-you-don%E2%80%99t-disconnect-LC-Phone-accounts,-you-may-still-be-charged-for-usage.)
    
-   [How to View Bulk Action History](#How-to-View-Bulk-Action-History)
    
    -   [Step 1: Open Bulk Action History](#Step-1%3A%C2%A0Open-Bulk-Action-History)
    -   [Step 2: Drill into Job Details](#Step-2%3A%C2%A0Drill-into-Job-Details)
    

* * *

# **How to Enable SaaS Mode in Bulk**
...
# **How to Pause Sub-Accounts in Bulk**

###   

### **Step 1:** Select sub-accounts for bulk action & initiate pause action
...
-   Then click on the '**Bulk****Actions**' dropdown and choose '**Pause****Sub**\-**Accounts**'.  
    \[Use filters (like activity or plan status) to easily segment accounts for pausing.\]  
...
# **How to View Bulk Action History**
