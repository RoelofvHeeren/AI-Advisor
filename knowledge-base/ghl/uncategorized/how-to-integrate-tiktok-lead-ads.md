---
title: "How to Integrate TikTok Lead Ads"
...
-   [Can the same TikTok account ID be connected to multiple sub-accounts in HL (same agency or across different agencies) without issues?](#Can-the-same-TikTok-account-ID-be-connected-to-multiple-sub-accounts-in-HL-\(same-agency-or-across-different-agencies\)-without-issues?)
