---
title: "Custom Product Details Page for E-commerce Stores"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006238-custom-product-details-page-for-e-commerce-stores"
category: "Uncategorized"
---

# Custom Product Details Page for E-commerce Stores

**Custom Product Details Page (PDPs)** in HighLevel let you build dedicated, on-brand pages for individual products—perfect for richer storytelling and higher conversions. Use the builder you already know to design, assign, and manage PDPs that override the default product detail experience. Routing from Product Listings Page (PLP), featured sections, and direct links automatically respects your mapping, with a safe fallback to the default PDP if needed. This guide walks you through benefits, setup, and best practices. 

* * *

**TABLE OF CONTENTS**

-   [What is Custom Product Details Pages for E-commerce Stores?](#What-is-Custom-Product-Details-Pages-for-E-commerce-Stores?)
    -   [Key Benefits of Custom Product Details Pages for E-commerce Stores](#Key-Benefits-of-Custom-Product-Details-Pages-for-E-commerce-Stores)
    -   [How To Setup Custom Product Details Pages for E-commerce Stores](#How-To-Setup-Custom-Product-Details-Pages-for-E-commerce-Stores)
    -   [Assigning, Reassigning & Managing Products](#Assigning,-Reassigning-&-Managing-Products)
...
Custom Product Details Pages are purpose-built product pages you create in HighLevel’s Site/Store Builder and map to specific products. Instead of relying on a **single default PDP**, you can craft unique layouts and messages per product while keeping store navigation intact. When a product has a Custom PDP, shoppers who click it from the Product List Page (PLP), featured sections, or any link will be taken to that custom page.
...
4.  Click **Save** and **Publish**.  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053146585/original/mPAAgo6go-xmtsKzt4yn13DV_Qw-rUwB8Q.png?1757040891)
...
-   [How to Sort and Filter Products in HighLevel Ecommerce Site Builder](https://help.gohighlevel.com/support/solutions/articles/155000003046-how-to-sort-and-filter-products-in-highlevel-ecommerce-site-builder?utm_source=chatgpt.com)  
      
    
-   [Manual Product Sorting on Product List Page in Ecommerce Stores](https://help.gohighlevel.com/support/solutions/articles/155000005531-manual-product-sorting-on-product-list-page-in-ecommerce-stores?utm_source=chatgpt.com)  
      
    
-   [Related Product element for Ecommerce stores](https://help.gohighlevel.com/support/solutions/articles/155000002844-related-product-element-for-ecommerce-stores?utm_source=chatgpt.com)  
      
    
-   [How to Suggest Related Product(s) in Your Product Details Page](https://help.gohighlevel.com/support/solutions/articles/155000002834-how-to-suggest-related-product-s-in-your-product-details-page?utm_source=chatgpt.com)  
      
    
-   [Text Customization in Ecommerce Stores](https://help.gohighlevel.com/support/solutions/articles/155000004647-text-customization-in-ecommerce-stores?utm_source=chatgpt.com)