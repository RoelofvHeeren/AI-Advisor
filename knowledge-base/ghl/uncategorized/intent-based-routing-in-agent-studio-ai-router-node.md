---
title: "Intent based Routing in Agent Studio (AI Router Node)"
...
-   [What is Intent Based Routing in Agent Studio?](#What-is-Intent-Based-Routing-in-Agent-Studio?)
    -   [Key Benefits of Intent Based Routing in Agent Studio](#Key-Benefits-of-Intent-Based-Routing-in-Agent-Studio)
    -   [Adding and Configuring the AI Router Node](#Adding-and-Configuring-the-AI-Router-Node)
    -   [Enhanced Logging for Routing Decisions](#Enhanced-Logging-for-Routing-Decisions)
    -   [Leveraging Variables in Intent Labels](#Leveraging-Variables-in-Intent-Labels)
    -   [Setup Intent Based Routing (AI Router Node)](#Setup-Intent-Based-Routing-\(AI-Router-Node\))
