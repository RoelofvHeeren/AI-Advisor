...
url: "https://help.gohighlevel.com/support/solutions/articles/155000002087-reporting-faqs"
...
-   [FAQ: Google Ads Tracking and Reporting](#FAQ%3A-Google-Ads-Tracking-and-Reporting)
    ...
    -   [Q: Why is my Sales count 0 (zero)?](#Q%3A-Why-is-my-Sales-count-0-\(zero\)?)
...
-   [FAQs for Facebook Ad Reporting](#FAQs-for-Facebook-Ad-Reporting)
    -   [Q: Why is my Sales count 0 (zero)?](#Q%3A-Why-is-my-Sales-count-0-\(zero\)?-1)
