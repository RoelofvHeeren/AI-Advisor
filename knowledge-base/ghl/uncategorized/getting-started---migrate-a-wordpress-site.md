---
title: "Getting Started - Migrate a Wordpress Site"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005070-getting-started-migrate-a-wordpress-site"
...
1.  Go to **Sites → WordPress** in your agency view.  
      
    
2.  Select **Clone** (or open the source site and choose **Clone**).  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061935643/original/kc2WPBJUR-soXxKZOmOl_U1lKGSRDu58Sw.png?1767628547)  
    
3.  Choose the **Destination Sub-Account**.  
      
    
4.  Pick the **Source Site** (if not already selected) and give the clone a **Name**.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061935751/original/-zqw5PCHVaZhJA9gFb3U7ZtCdX-XZURUyg.png?1767628615)  
    
5.  Click **Clone** to start the duplication.  
      
    
6.  Monitor progress until the status shows **Completed.**
