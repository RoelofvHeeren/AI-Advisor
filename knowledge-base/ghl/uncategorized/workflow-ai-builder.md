...
-   [What is Workflow AI Builder?](#What-is-Workflow-AI-Builder?)[](#Key-Benefits-of-Workflow-AI-Builder)
-   [Key Benefits of Workflow AI Builder](#Key-Benefits-of-Workflow-AI-Builder)[](#Entry-Points)
-   [Entry Points](#Entry-Points)[](#How-to-Build-Your-First-AI-Workflow)
-   [How to Build Your First AI Workflow](#How-to-Build-Your-First-AI-Workflow)[](#Point-and-Edit-for-Precise-Control)
-   [Point and Edit for Precise Control](#Point-and-Edit-for-Precise-Control)[](#Chat-mode)
-   [Chat mode](#Chat-mode)[](#Best-Practices-for-Effective-Prompts)
-   [Best Practices for Effective Prompts](#Best-Practices-for-Effective-Prompts)[](#Providing-Feedback)
-   [Providing Feedback](#Providing-Feedback)[](#Beta-Limitations)
-   [Beta Limitations](#Beta-Limitations)
-   [Troubleshooting](#Troubleshooting)[](#Quick-Tips)
-   [Quick Tips](#Quick-Tips)[](#Frequently-Asked-Questions)
-   [Frequently Asked Questions](#Frequently-Asked-Questions)[](#Related-Articles)
-   [Related Articles](#Related-Articles)[](#Workflows-Landing-Page%C2%A0)
-   [Workflows Landing Page](#Workflows-Landing-Page%C2%A0) 
...
### **Step1:** From the Workflow List Page
...
### **Step2:** From the Prompt Box Inside Workflow Builder

When creating a new workflow from scratch, you'll find an AI prompt box in the workflow builder. Simply type your automation requirements there.
...
### **Step3:** Using the AI Chatbot Assistant
...
Yes. Use conversational edits to add, remove, replace, move, or modify actions and triggers. Multi‑path configuration edits are limited today.
