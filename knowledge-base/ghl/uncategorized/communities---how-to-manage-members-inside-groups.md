---
title: "Communities - How to Manage Members Inside Groups"
url: "https://help.gohighlevel.com/support/solutions/articles/155000000289-communities-how-to-manage-members-inside-groups"
category: "Uncategorized"
---

# Communities - How to Manage Members Inside Groups
...
-   [What is Managing Members Inside Groups](#What-is-Managing-Members-Inside-Groups)[](#Key-Benefits-of-Managing-Members-Inside-Groups)
-   [Key Benefits of Managing Members Inside Groups](#Key-Benefits-of-Managing-Members-Inside-Groups)[](#Understanding-Member-Roles-&-Permissions)
-   [Understanding Member Roles & Permissions](#Understanding-Member-Roles-&-Permissions)[](#How-to-Invite-Members-to-the-Group)
-   [How to Invite Members to the Group](#How-to-Invite-Members-to-the-Group)[](#Privacy-&-Join-Flow-\(Public-vs-Private\))
-   [Privacy & Join Flow (Public vs Private)](#Privacy-&-Join-Flow-\(Public-vs-Private\))[](#How-to-Modify-Member-Roles)
-   [How to Modify Member Roles](#How-to-Modify-Member-Roles)[](#How-to-Remove-or-Ban-Members)
-   [How to Remove or Ban Members](#How-to-Remove-or-Ban-Members)[](#Frequently-Asked-Questions)
...
**Note:** A group can only be **Deactivated** and **cannot be Deleted**.

  

**Default roles and typical abilities**
...
Moderator is a **group-level role** used for content/member moderation. Owners/Admins can assign it from the **Members** list for a group. If you don’t see “Moderator” as an option, check that you’re editing **inside the Group’s Members screen** (not Contacts), and that you’re an **Owner/Admin** for that group.
...
2.  **Login** to your group.  
      
    ![](https://jumpshare.com/share/oWksATMpugNObgsbTAyg+/GIF+Recording+2025-12-19+at+5.14.14+PM.gif)  
      
    
3.  Click on **Invite Members**.  
      
    ![](https://jumpshare.com/share/dHWA0uD4sNAUI2k0V18N+/Screen+Shot+2025-12-19+at+5.17.24+PM.png)  
      
    
4.  **Copy the Invite Link** and send via email, SMS, WhatsApp, etc.  
      
    ![](https://jumpshare.com/share/gOYZ28ELEtuSU7uHAaKt+/Screen+Shot+2025-12-19+at+5.19.04+PM.png)  
...
4.  Under **Email Invite**, enter name and email id of the recipient.  
      
    
5.  Turn **Administrative** **Privileges** **ON**/**OFF**.  
      
    
6.  Click on **Send Invite**, recipients receive an email with the join action.  
      
    ![](https://jumpshare.com/share/4P79IYkBlKbwkjmH4I7W+/Screen+Shot+2025-12-19+at+5.37.49+PM.png)
...
-   **Private Groups:** Only members can see the group posts and other members of the group. All join attempts require manual review **even when the person uses an invite link**.  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061005649/original/c0pcZmG8EM4SLmrLPjAHoHiFf08WCofhOg.png?1766147508)
...
1.  Go to **Members > Contributors >** locate the member **\>**  click **… (three dots)**.  
      
    
2.  Select _Admin, Moderator,_ or _Contributor_ (available options depend on your group configuration and your own permissions).  
      
    **![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061008125/original/LpOTHmBNVtyDkdylsGKNEJEYRwkiVb1xMA.png?1766148796)**
...
-   **To remove/ban:** go to **Members** > locate member > **… (three dots)** > click on **Ban** or **Remove from Group**.  
    ...
    ![](https://jumpshare.com/share/flevGp36nXneQ8F9J8yp+/Screen+Shot+2025-12-19+at+6.17.07+PM.png)
...
**Q: I see “Moderator” mentioned, but I don’t see it in the role picker. How do I make someone a Moderator?**Open the community **Group → Members**, find the person, click **⋯ (three dots)**, and choose **Moderator**. Only **Owners/Admins** can assign roles. If the option doesn’t appear, ensure you’re changing roles from the **Group’s Members** list (not Contacts), and that you have **Owner/Admin** access to that group.
...
-   [How to Make Groups Private in Communities](https://help.gohighlevel.com/en/support/solutions/articles/155000000735) 
...
-   [Skool to HighLevel (Migration Guide)](https://help.gohighlevel.com/en/support/solutions/articles/155000003309)