---
title: "Recover Lost Sales with Automatic Abandoned Checkout Emails"
...
-   [What is Automatic Abandoned Cart Checkout Email?](#What-is-Automatic-Abandoned-Cart-Checkout-Email?)
    -   [Key Benefits of Abandoned Checkout Emails](#Key-Benefits-of-Abandoned-Checkout-Emails)
    -   [How the Abandoned Cart Link Works](#How-the-Abandoned-Cart-Link-Works)
    ...
    -   [Customizing the Abandoned Checkout Email](#Customizing-the-Abandoned-Checkout-Email)
...
An **a****utomatic abandoned checkout email** is triggered when a customer adds items to their shopping cart, begins the checkout process, enters their email address, but doesn’t complete the purchase. The system detects this incomplete action and automatically sends a follow-up email to encourage the customer to return and finish the checkout. This email includes a link to access the abandoned cart.
...
Customers can resume checkout from any device using the unique link sent in the abandoned checkout email. Understanding how this link behaves helps you set the right expectations when using automatic abandoned cart emails.  
  

-   **Cross-device access:** The link works across devices, browsers, and sessions.  
      
    
-   **One link per abandoned cart:** Each URL represents a single abandoned session; only those items appear.  
      
    
-   **View-only cart:** Shoppers can’t add new items from this link.  
      
    
-   **Dynamic updates:** The checkout shows the latest product names and prices at open time.  
...
**Q: Is the abandoned cart link shareable?**  
Yes. It works across devices, browsers, and sessions.
