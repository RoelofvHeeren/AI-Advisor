---
title: "App Permissions in Client Portal: Enabling/Disabling a child app"
url: "https://help.gohighlevel.com/support/solutions/articles/155000002136-app-permissions-in-client-portal-enabling-disabling-a-child-app"
...
-   [How to Customise App Permissions](#How-to-Customise-App-Permissions)[](#Accessing-App-Permissions%E2%80%8B%E2%80%8B)
-   [Accessing App Permissions](#Accessing-App-Permissions%E2%80%8B%E2%80%8B)[](#Enabling/Disabling-Apps%E2%80%8B)
-   [Enabling/Disabling Apps](#Enabling/Disabling-Apps%E2%80%8B)[](#Setting-Your-Default-Page%E2%80%8B)
-   [Setting Your Default Page](#Setting-Your-Default-Page%E2%80%8B)[](#Auto-Define-Permissions-\(Visibility-Rules\))
-   [Auto Define Permissions (Visibility Rules)](#Auto-Define-Permissions-\(Visibility-Rules\))[](#What-%E2%80%9Celigible-content%E2%80%9D-means-\(examples\))
-   [What “eligible content” means (examples)](#What-%E2%80%9Celigible-content%E2%80%9D-means-\(examples\))[](#FAQ%E2%80%8B)
-   [FAQ](#FAQ%E2%80%8B)
...
### **Auto Define Permissions (Visibility Rules)  
**

Client Portal apps follow **two visibility checks** for each contact:  
  

1.  The app must be **enabled** in App Permissions by the Client Portal owner.  
...
A contact may only see an app when they have relevant content such as:  
  

-   **Courses**: The contact can see Courses after they have a course to access (for example, after their first course purchase/access is granted).  
      
    
-   **Invoices / Estimates / Contracts**: The contact can see these apps when there’s something available to review (for example, an invoice to check).  
      
    
-   **Affiliates**: The contact can see the app when there’s relevant affiliate access/activity for them.
