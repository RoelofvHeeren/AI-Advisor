---
title: "How to Set Up Two Way Email Sync for Gmail"
url: "https://help.gohighlevel.com/support/solutions/articles/48001235216-how-to-set-up-two-way-email-sync-for-gmail"
...
#### **[What is Gmail Two way sync?](#What-is-Gmail-Two-way-sync?)**
...
#### [Update Email:](#Update-Email%3A%C2%A0) 

#### [Disconnect Email:](#Disconnect-Email%3A%C2%A0) 

#### [BCC Address](#Auto-Bcc-Sync) 

#### [Does Two-way sync only work with individual emails or bulk emails and workflows?](#Does-Two-way-sync-only-work-with-individual-emails-or-bulk-emails-and-workflows?)

####   
[**FAQs**](#FAQs)

#### [What happens to emails received from existing contacts?](#What-happens-to-emails-received-from-existing-contacts?)

#### [Will removing a synced account delete existing emails?](#Will-removing-a-synced-account-delete-existing-emails?)

#### [Do new emails get synced after an account is removed?](#Do-new-emails-get-synced-after-an-account-is-removed?)

#### [Will all my existing contacts in Gmail be synced with the CRM?](#Will-all-my-existing-contacts-in-Gmail-be-synced-with-the-CRM?)

#### [What happens when a new email is received from a contact?](#What-happens-when-a-new-email-is-received-from-a-contact?)

#### [What happens to sent emails from the CRM or Gmail?](#What-happens-to-sent-emails-from-the-CRM-or-Gmail?)

#### [How are cc/bcc recipients handled in the sync?](#How-are-cc/bcc-recipients-handled-in-the-sync?)

#### [What if a contact emails someone else but includes the CRM user?](#What-if-a-contact-emails-someone-else-but-includes-the-CRM-user?)

#### [How is the conversation thread managed when multiple recipients are involved?](#How-is-the-conversation-thread-managed-when-multiple-recipients-are-involved?)

#### [What if the same contact exists in multiple locations for the same synced email address?](#What-if-the-same-contact-exists-in-multiple-locations-for-the-same-synced-email-address?)

#### [What is Auto Bcc Sync, and how does it work?](#What-is-Auto-Bcc-Sync,-and-how-does-it-work?)

#### [How is the secure connection handled if Gmail login credentials change?](#How-is-the-secure-connection-handled-if-Gmail-login-credentials-change?)

#### [What happens when an email is forwarded from Gmail?](#What-happens-when-an-email-is-forwarded-from-Gmail?)

#### [What if there are duplicate emails with multiple contacts?](#What-if-there-are-duplicate-emails-with-multiple-contacts?)
...
1.  When prompted, select an **existing Gmail account** from your browser or **connect a new one**.  
      
    ![](https://jumpshare.com/v/pyfsQ5yCK84VSJVlqYrl+/Screen+Shot+2025-07-02+at+8.12.03+PM.png)  
      
    
2.  Review the permission request from LeadConnector and click on **Continue**.  
      
    ![](https://jumpshare.com/v/3Fc5qPd96ToyGYIXqsVG+/Screen+Shot+2025-07-02+at+8.15.06+PM.png)  
      
    
3.  Review access request and click on **Allow**.  
      
    ![](https://jumpshare.com/v/hM5TOUUORZy9NJL4LzRA+/Screen+Shot+2025-07-02+at+8.20.01+PM.png)  
      
    
4.  After completing the steps, your selected **Gmail account will appear under the Email Two-Way Sync** tab.  
      
    ![](https://jumpshare.com/v/ht8e2lZdUhloQsIBkHeB+/Screen+Shot+2025-07-02+at+8.32.10+PM.png)
