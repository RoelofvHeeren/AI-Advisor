---
title: "Preference Management (Email Unsubscription Management)"
url: "https://help.gohighlevel.com/support/solutions/articles/155000007291-preference-management-email-unsubscription-management-"
...
-   [What is Preference Management?](#What-is-Preference-Management?)
    -   [Key Benefits of Preference Management](#Key-Benefits-of-Preference-Management)
    -   [Preference Types](#Preference-Types)
    -   [Associating Preferences with Campaigns](#Associating-Preferences-with-Campaigns)
    -   [Automatic Audience Filtering](#Automatic-Audience-Filtering)
    -   [How To Setup Preference Management](#How-To-Setup-Preference-Management)
    -   [Managing Preferences at the Contact Level](#Managing-Preferences-at-the-Contact-Level)
...
For more information on creating preferences, [click here.](#Step-1%3A-Create-Preference-Types)
...
For more information on how to associate preferences with campaigns, [click here.](#Step-2%3A-Assign-Preferences-to-Campaigns)
...
####   
**Step 2:** Assign Preferences to Campaigns
