...
#### [**How to set up FB CAPI (Conversions API) Lead Event?**](#How-to-set-up-FB-CAPI-\(Conversions-API\)-Lead-Event?)
...
4.  After this, add another action for **"Meta Conversion API".**   
