---
title: "How to Filter Contacts by Email Statistics"
url: "https://help.gohighlevel.com/support/solutions/articles/155000000330-how-to-filter-contacts-by-email-statistics"
...
-   [What is Filtering Contacts by Email Stats?](#What-is%C2%A0Filtering-Contacts-by%C2%A0Email-Stats?)[](#Key-Benefits-of-Filtering-Contacts-by%C2%A0Email-Stats)
-   [Key Benefits of Filtering Contacts by Email Stats](#Key-Benefits-of-Filtering-Contacts-by%C2%A0Email-Stats)[](#How-To-Filter-Contacts-by-Email-Statistics)
-   [How To Filter Contacts by Email Statistics](#How-To-Filter-Contacts-by-Email-Statistics)[](#Frequently-Asked-Questions)
...
2.  Go to **Settings** → **Email Services** → **Email Analytics**.  
      
    ![](https://jumpshare.com/share/bprRykWzXSKjURMczcWU+/GIF+Recording+2025-12-31+at+3.48.16+PM.gif)  
      
    
3.  Review **Email Metrics** (Sent, Delivered, Opened, Clicked, Complained, Bounced, Unsubscribed, Failed).  
      
    ![](https://jumpshare.com/share/nHDHMg85jOYSP0K4QDUc+/Screen+Shot+2025-12-31+at+3.49.35+PM.png)  
      
    
4.  You can set a **Date Range** for your analysis window.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061665817/original/Rzk851hBFRZOzOnatjfGFu63drYiHRCRlw.png?1767176543)  
      
    
5.  You can click **Filters** and choose **Email Source**, select **Campaign**, **Workflow**, or **Bulk Request**.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061666100/original/o2zxBJeoftfqcYM1eNwgz6SsMwtkX-eliA.png?1767176684)  
      
    
6.  Choose an **Email Source Name** (the specific campaign, workflow, or bulk send). _Selecting the source name is required to return results._  
      
    _![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155061666434/original/RUKyExutxMBhhxyfWRx1Lc8a7MsueP480w.png?1767176780)_  
      
    
7.  Click a **metric box** (e.g., **delivered**) to open the **contact list** that matches.  
      
    ![](https://jumpshare.com/share/TsMIT4JD3O0Y3A2wy2wA+/Screen+Shot+2025-12-31+at+3.57.42+PM.png)  
      
    
8.  Use **Pagination** (20/50/100), adjust **Date Range**, and **Refresh** as needed.  
      
    ![](https://jumpshare.com/share/4qkAMKpXvHhoNlZiKkJG+/Screen+Shot+2025-12-31+at+3.59.04+PM.png)  
      
    
9.  Click a **contact** to open the **Contact record** for deeper context or actions.  
      
    ![](https://jumpshare.com/share/50TaqXT09ew0YhONKegH+/Screen+Shot+2025-12-31+at+4.03.41+PM.png)
...
-   [Troubleshooting Email Statistics](https://help.gohighlevel.com/en/support/solutions/articles/48001208601) 
    
-   [Email Statistics – Summary Page](https://help.gohighlevel.com/en/support/solutions/articles/155000006834)