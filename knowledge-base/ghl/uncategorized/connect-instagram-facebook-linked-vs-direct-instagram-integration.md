---
title: "Connect Instagram: Facebook-Linked vs. Direct Instagram Integration"
...
-   [Method 1: Facebook-Linked Integration (Classic)](#Method-1%3A-Facebook-Linked-Integration-\(Classic\))
-   [Method 2: Direct Instagram Integration (Recommended)](#Method-2%3A-Direct-Instagram-Integration-\(Recommended\))
...
The key distinction between your options is:

  

1.  **Direct Instagram Integration (new)**: Does NOT require you to connect a Facebook page during setup in Social Planner. You authenticate only with Instagram. This allows you to skip the traditional "connect Facebook page and then connect Instagram Business page" flow. However, Instagram/Facebook (not HighLevel) still requires the underlying profile to be either:
    1.  a Business profile linked to a Facebook page
    2.  a Creator profile (does not require a Facebook page)  
          
        
2.  **Facebook-linked Integration**: This requires explicitly connecting a Facebook page inside Social Planner. You only need this if you want legacy Facebook permissions or view-count analytics.
