---
title: "Wix to HighLevel (Migration Guide)"
...
-   [Recreate Pipelines (Wix Workflows)](#Recreate-Pipelines-\(Wix-Workflows\))
-   [Migrate Products (Wix Stores)](#Migrate-Products-\(Wix-Stores\))
