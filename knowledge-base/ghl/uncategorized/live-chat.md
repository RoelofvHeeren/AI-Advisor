---
title: "Live Chat"
url: "https://help.gohighlevel.com/support/solutions/articles/155000001320-live-chat"
...
**Intro Message:** A short greeting that appears before the chat starts. [Click here for more information on customizing the intro message.](https://help.gohighlevel.com/support/solutions/articles/155000005415-collect-visitor-details-before-live-chat-starts#Customize-Contact-Form-Messages)
...
Chats can be assigned manually or automatically to team members. Below is a **suggestive workflow** you can follow to automatically assign a live chat to a specific user.  
  
It’s a simple setup that routes chats from a chosen chat widget directly to a designated team member.

  

1.  **Create a new workflow** → Go to _Automations → Workflows_ → Click **\+ New Workflow**.  
      
    
2.  **Add Trigger** → Click **Add New Trigger** → Select **Customer Replied** or **New Chat Message**.  
      
    
3.  **Add Filters** → Under trigger filters, set **Channel = Live Chat**, then add another filter **Chat Widget is →** choose the desired widget from the dropdown.  
      
    
4.  **Add Action** → Click **+** below the trigger → Choose **Assign to User**.  
      
    
5.  **Select User** → In the action settings, pick the specific user you want the chat assigned to.  
      
    
6.  **Save & Publish** → Click **Save**, then toggle from **Draft → Publish**.
    

  
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155058670834/original/VuhoQ67sjZZjeZ9z1u5bcvupUpdZChh8qQ.gif?1763479581)
