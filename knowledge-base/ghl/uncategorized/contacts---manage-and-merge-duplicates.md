---
title: "Contacts - Manage and Merge Duplicates"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006647-contacts-manage-and-merge-duplicates"
...
-   [What is the Duplicate Contact Management & Merge Tool?](#What-is-the-Duplicate-Contact-Management-&-Merge-Tool?)[](#Key-Benefits-of-Duplicate-Contact-Management-&-Merge-Tool)
-   [Key Benefits of Duplicate Contact Management & Merge Tool](#Key-Benefits-of-Duplicate-Contact-Management-&-Merge-Tool)[](#Permissions-&-Restrictions)
-   [Permissions & Restrictions](#Permissions-&-Restrictions)[](#Additional-Limits)
-   [Additional Limits](#Additional-Limits)[](#Best-Practices)
-   [Best Practices](#Best-Practices)[](#How-To-Merge-and-Manage-Duplicate-Contacts)
-   [How To Merge and Manage Duplicate Contacts](#How-To-Merge-and-Manage-Duplicate-Contacts)[](#Troubleshooting)
...
If a workflow appears to stop after a merge, open the workflow’s **Execution Logs** to confirm whether the execution was transferred to the master contact or stopped because the master was already enrolled.
...
**Q: What happens to in-progress workflows when I merge duplicate contacts?**

  
If a duplicate contact is deleted during a merge, HighLevel transfers the workflow execution to the master contact so the automation continues without losing progress.

**Q: What if the master contact is already enrolled in the same workflow?**

  
HighLevel stops the extra run and keeps the workflow execution that is already running for the master contact. In Execution Logs, you may see a note similar to:
