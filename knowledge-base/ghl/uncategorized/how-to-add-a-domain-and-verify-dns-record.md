---
title: "How to Add a Domain and Verify DNS Record"
...
-   [What You’ll Need Before You Start](#%E2%80%8B%E2%80%8BWhat-You%E2%80%99ll-Need-Before-You-Start)
-   [Step 1: Add Your Domain](#Step-1%3A-Add-Your-Domain)
-   [Step 2: Verify Your Domain](#Step-2%3A-Verify-Your-Domain)
    -   [What DNS Record Types Are Needed & Why](#What-DNS-Record-Types-Are-Needed-&-Why)
    -   [Verifying Your Domain from the Menu](#Verifying-Your-Domain-from-the-Menu)
    -   [Checking Your DNS Records](#Checking-Your-DNS-Records)
    -   [Option 1: Auto‑Configure via DNS Provider Integration](#Option-1%3A-Auto%E2%80%91Configure-via-DNS-Provider-Integration)
    -   [Option 2: Manual DNS Setup](#Option-2%3A-Manual-DNS-Setup)
        -   [General Setup Guidelines](#General-Setup-Guidelines)
    -   [Examples by DNS Provider](#Examples-by-DNS-Provider)
