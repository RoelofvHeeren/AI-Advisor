---
title: "Ad Manager - Create a Google Search Ad Campaign"
url: "https://help.gohighlevel.com/support/solutions/articles/155000004543-ad-manager-create-a-google-search-ad-campaign"
category: "Uncategorized"
---

# Ad Manager - Create a Google Search Ad Campaign

HighLevel Ad Manager allows you to run the ad campaigns on Google. Your Google Ads campaign is entirely in your control: design your ad content, choose your daily budget and set a specific target audience with geography and languages. 
...
# **What is Creating a Google Search Ad Campaign in HighLevel Ad Manager?**
...
2\. Toggling ON/OFF Ad Manager for a sub-account will ensure the visibility of Ad Manager tab under sub-account > marketing.  
...
**Note:** The option to Include/Exclude a selected geographic location by Radius is not supported by Google. When defining the geographic location by radius, the radius around the specified address can be modified to be included as the audience reach.
...
When creating a Google Ads campaign, you must confirm whether the campaign includes European Union (EU) political ads.  

  

**Note:** You **must make a selection to continue** and publish the campaign. Use this [**article**](https://support.google.com/adspolicy/answer/6014595?hl=en) to review Google’s Political content policy.

  
Select one option:  
  

1.  **Yes:** The campaign contains EU political ads.  
      
    
2.  **No:** The campaign does not contain EU political ads.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155064111745/original/ZacTti9cpKyzje2tJ2GCCGYFtKr3Cg_vmw.jpeg?1770135226)  
      
    **C: Language** \- Enter any language spoken by the users you want to target. Multiple languages can be searched and selected for a campaign.  
...
**Note:** Checkout the detailed article on [How to Configure Google Ads Additional Assets at Campaign Level](https://help.gohighlevel.com/en/support/solutions/articles/155000005789) 
...
Under Negative keywords, you can optionally add words or phrases that you do not want matched with your ad. 

  

Anyone who searches on Google with one of these negative keywords will not see your ad.
...
[https://support.google.com/adspolicy/answer/6008942?visit\_id=638814115746281060-874345944&rd=1](https://support.google.com/adspolicy/answer/6008942?visit_id=638814115746281060-874345944&rd=1)