---
title: "Pin Your Favorite Groups"
url: "https://help.gohighlevel.com/support/solutions/articles/155000004884-pin-your-favorite-groups"
...
Courses can also be pinned. Pinned courses appear in the left sidebar under the ? icon, giving you one-click access to your favorite learning content.
...
1.  ## 
    ...
    Open the **Group Switcher** (located in the top navigation bar).
...
1\. Open GoKollab and locate the course you want to pin.

2\. Pin the course to add it to the left sidebar under the ? icon.

3\. Select the pinned course anytime to return to it quickly.
