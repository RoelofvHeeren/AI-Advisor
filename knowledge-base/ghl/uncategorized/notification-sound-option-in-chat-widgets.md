---
title: "Notification Sound Option in Chat Widgets"
url: "https://help.gohighlevel.com/support/solutions/articles/155000007165-notification-sound-option-in-chat-widgets"
...
-   [What is the Notification Sound Setting in Chat Widgets?](#What-is-the-Notification-Sound-Setting-in-Chat-Widgets?)
-   [Key Benefits of Notification Sounds in Chat Widgets](#Key-Benefits-of-Notification-Sounds-in-Chat-Widgets)
-   [How To Adjust The Notification Sound Setting](#How-To-Adjust-The-Notification-Sound-Setting)
...
# **What is the Notification Sound Setting in Chat Widgets?**
...
1.  Go to **Sites ➝ Chat Widgets** and open the widget you’d like to edit.  
    ...
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060355860/original/eWerku0Ofk7r0YQi96sOBxU5BMLVfRdVRw.png?1765403925)  
      
    
2.  In the left side menu, select the **Chat Window** tab then open the **Additional Options** dropdown**.**  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060355890/original/zLaqIcthVzL5wlYWuLp78KKnrwrf8mSniw.png?1765404001)  
      
    
3.  Toggle the **Notification Sound** to **ON** (recommended) or **OFF** based on your page strategy.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060355898/original/Bp_U16UuunuW2hEstOj-9UP4xt3zuyQGCw.png?1765404026)  
      
    
4.  Click **Save** in the top right. If the embed code is already on your site, refresh the page to see the applied changes.  
      
    ![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155060355916/original/z6jx_WeugE9XdEws0fkHq66uJtpS3r3YGg.png?1765404057)
...
-   [Getting Started with the Chat Widget](https://help.gohighlevel.com/en/support/solutions/articles/155000004102)  
      
    
-   [Getting Started - Setup Live Chat Widget](https://help.gohighlevel.com/en/support/solutions/articles/155000005067)  
      
    
-   [How to Use the All-in-One Chat Widget](https://help.gohighlevel.com/en/support/solutions/articles/155000004779)  
      
    
-   [How to Enable and Customize Live Chat Notifications](https://help.gohighlevel.com/en/support/solutions/articles/155000005924)  
