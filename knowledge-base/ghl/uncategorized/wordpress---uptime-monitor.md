---
title: "WordPress - Uptime Monitor"
url: "https://help.gohighlevel.com/support/solutions/articles/155000006937-wordpress-uptime-monitor"
...
-   [What is the WordPress Uptime Monitor?](#What-is-the-WordPress-Uptime-Monitor?)[](#Key-Benefits-of-the-Uptime-Monitor)
-   [Key Benefits of the Uptime Monitor](#Key-Benefits-of-the-Uptime-Monitor)[](#Status-&-Health-Cards)
-   [Status & Health Cards](#Status-&-Health-Cards)[](#Response-Time-Analytics)
-   [Response Time Analytics](#Response-Time-Analytics)[](#Recent-Events-\(Incident-Feed\))
-   [Recent Events (Incident Feed)](#Recent-Events-\(Incident-Feed\))[](#How-To-Use-the-WordPress-Uptime-Monitor)
-   [How To Use the WordPress Uptime Monitor](#How-To-Use-the-WordPress-Uptime-Monitor)[](#Frequently-Asked-Questions)
...
-   **Last Health Check:** Confirms the monitor is actively checking and when it last ran.  
    ...
    ![](https://jumpshare.com/share/xxgxgQfGsptHbtldJYKs+/Image-1.jpg)
...
-   Pair with hosting region guidance to reduce network latency for your audience.  
    ...
    ![](https://jumpshare.com/share/a9GKL9Uc6RZeaG2J7Nn4+/image-2.jpg)
...
-   Helpful during handoffs and client updates—copy the timestamps and notes into tickets and reports.  
    ...
    ![](https://jumpshare.com/share/ERZ6DVn3OfBirjIG4TLS+/image-3.jpg)
...
1.  Go to **Sites → WordPress**.  
    ...
    ![](https://jumpshare.com/share/U6fCpCjcEj00CEMGMxRp+/Screen+Shot+2025-11-11+at+7.07.25+PM.png)  
      
    
2.  Click **Manage Website** for the site you want to monitor.  
      
    ![](https://jumpshare.com/share/jB3ioQgJekLaaMnDKfWQ+/Screen+Shot+2025-11-11+at+7.11.31+PM.png)  
      
    
3.  Open **Analytics → Visitors Report**.  
      
    ![](https://jumpshare.com/share/T8VS4coIPAHy0BsZmhOg+/Screen+Shot+2025-11-11+at+7.17.38+PM.png)  
      
    
4.  Locate the **Uptime Monitor** toggle and switch it **On** to start monitoring.  
      
    ![](https://jumpshare.com/share/6q8j4MXzlxiJyBhNOcNI+/GIF+Recording+2025-11-11+at+7.19.58+PM.gif)
