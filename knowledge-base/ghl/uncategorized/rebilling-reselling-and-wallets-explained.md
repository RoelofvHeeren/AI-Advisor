---
title: "Rebilling, Reselling, and Wallets Explained"
url: "https://help.gohighlevel.com/support/solutions/articles/155000002095-rebilling-reselling-and-wallets-explained"
...
-   [How “Reselling” (Re-Sell) Works](#How-%E2%80%9CReselling%E2%80%9D-\(Re-Sell\)-Works)
    -   [Option 1: Direct Deployment](#Option-1%3A-Direct-Deployment)
    -   [Option 2: Reselling (with or without markup)](#Option-2%3A-Reselling-\(with-or-without-markup\))
...
| **Term** | **Definition** |
| --- | --- |
| **Wallet** | A pre-loaded balance of credits used to pay for usage-based services (SMS, email, calls, etc.). Auto-recharge tops it up when the balance drops below a set threshold. |
| **Auto-Recharge** | Automatically refills the Wallet by charging a preset amount to the card on file when the balance falls below the minimum threshold. |
| **Agency Stripe Account** | The Stripe account connected at the Agency level. Used to charge clients for subscriptions, usage, markups, rebilling fees, and other billable items. |
| **Sub-Account** | A client account under your Agency. Each Sub-Account can have its own Wallet and rebilling settings. |
| **Rebilling** | Charging clients for usage-based services. The agency pays the wholesale cost and adds a markup; the client is billed for total usage + markup. |
| **Markup** | The margin added on top of HighLevel’s base cost when rebilling clients for usage services. |
| **Reselling** | Selling SaaS-style or fixed-price products (email bundles, phone numbers, subscriptions). The agency collects payment; HighLevel deducts wholesale cost automatically. |
| **LC Services** | HighLevel’s internal billing system where usage-based costs originate. Wallet funds are used to pay these costs. |
| **Phone/SMS/Email Usage** | Consumption-based communication services that deduct from Wallet balance or are rebilled to clients if enabled. |
| **Threshold** | The minimum Wallet balance that triggers an auto-recharge event. |
| **Card on File** | The saved payment method used for wallet top-ups or client billing. |
...
For pricing information and setup instructions for many of these services, visit the [HighLevel Pricing Guide.](https://help.gohighlevel.com/en/support/solutions/articles/155000001156)[](https://help.gohighlevel.com/en/support/solutions/articles/155000001156)**[](https://help.gohighlevel.com/en/support/solutions/articles/155000001156)**