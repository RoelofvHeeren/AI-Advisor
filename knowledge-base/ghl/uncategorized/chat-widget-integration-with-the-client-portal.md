---
title: "Chat Widget Integration with the Client Portal"
url: "https://help.gohighlevel.com/support/solutions/articles/155000005913-chat-widget-integration-with-the-client-portal"
...
-   [What is Chat Widget Integration with the Client Portal?](#What-is-Chat-Widget-Integration-with-the-Client-Portal?)
-   [Key Benefits of Chat Widget Integration with the Client Portal:](#Key-Benefits-of-Chat-Widget-Integration-with-the-Client-Portal%3A%C2%A0) 
-   [How To Setup Chat Widget Integration in the Client Portal](#How-To-Setup-Chat-Widget-Integration-in-the-Client-Portal)
-   [Child App–Specific Widget Visibility](#Child-App%E2%80%93Specific-Widget-Visibility)
...
1.  In your sub-account, go to **Memberships** **→** **Client Portal → Settings → Chat Widget**  
    ...
    _![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155051812720/original/7N256pP56TDZeXDqnNwXVmHUVPksxVk-8Q.gif?1755520196)_  
...
-   You’ve **already created** at least one Chat Widget in the sub-account (see **[Getting Started with Chat Widget](https://help.gohighlevel.com/support/solutions/articles/155000004102-getting-started-with-chat-widget)** and **[How to Use the All-in-One Chat Widget](https://help.gohighlevel.com/support/solutions/articles/155000004779-how-to-use-the-all-in-one-chat-widget)**).  
      
    
-   You have access to **Client Portal** settings in the sub-account.  
      
    
-   (Optional) Channel requirements are met (e.g., WhatsApp number if you plan to use WhatsApp in your widget).
...
**I**t appears in supported views of that child app. If you don’t see it, refresh and confirm the child app toggle is enabled.  
...
-   [How to Use the All-in-One Chat Widget](http://help.gohighlevel.com/support/solutions/articles/155000004779-how-to-use-the-all-in-one-chat-widget)  
      
    
-   [Getting Started with Chat Widget](http://help.gohighlevel.com/support/solutions/articles/155000004102-getting-started-with-chat-widget)  
      
    
-   [How to set up the Client Portal](http://help.gohighlevel.com/support/solutions/articles/155000000193-how-to-set-up-the-client-portal-)  
      
    
-   [How to Setup, Customize, and Manage Your Communities](http://help.gohighlevel.com/support/solutions/articles/155000000280-how-to-setup-customize-and-manage-your-communities)  
      
    
-   [Getting Started — Launch a Course](http://help.gohighlevel.com/support/solutions/articles/155000005072/)  
      
    
-   [How to Use the Affiliate Portal: A Comprehensive Guide for Affiliates](http://help.gohighlevel.com/support/solutions/articles/155000003650-how-to-use-the-affiliate-portal-a-comprehensive-guide-for-affiliates)