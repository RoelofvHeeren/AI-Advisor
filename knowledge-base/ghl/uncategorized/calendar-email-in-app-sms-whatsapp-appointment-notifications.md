---
title: "Calendar: Email, In-App, SMS & Whatsapp Appointment Notifications"
...
-   [What are Customizable Calendar Notifications?](#What-are-Customizable-Calendar-Notifications?)
...
-   [In-App Appointment Notifications](#In-App-Appointment-Notifications)
-   [SMS Appointment Notifications](#SMS-Appointment-Notifications)
-   [Whatsapp Appointment Notifications](#Whatsapp-Appointment-Notifications)
...
**Note:** To prevent missed meetings, staff can enable **internal** alerts/notifications for appointments booked **without a meeting link/location**. Configure it in **Settings → My Staff → \[Staff\] → Notification Settings → Calendar Notifications **→ Notify when meeting link/location is missing****.
