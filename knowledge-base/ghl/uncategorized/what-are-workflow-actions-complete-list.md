---
title: "What Are Workflow Actions? (Complete List)"
...
-   [Action Categories](#Action-Categories)
    ...
    -   [IVR (Interactive Voice Response) Actions](#IVR-\(Interactive-Voice-Response\)-Actions)
...
-   Creates a task related to a contact.  Attaches to the contact if one exists; **creates a contact-less task** if the workflow is running without a contact. Pair with Inbound Webhook to create internal tasks even when no contact exists.
